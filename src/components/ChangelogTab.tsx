  ...
  const changelog: ChangelogContent[] = [
    ...
    },
    {
      ...
      content: [
        ...
        `equipped.webp`,
        leaks(`Added Lushaka set to teammate effects`),
        leaks(`lushaka.webp`),
        ...
        leaks(`Fix: Lingsha calculations now correctly take into account teammate super break triggers`),
        `Balance: Himeko's default ornament set is now Duran`,
        `Balance: Dr Ratio's default ornament set is now Duran`,
        leaks(`Balance: Feixiao secondary ult now forces weakness break to enabled`),
        leaks(`Balance: Removed break damage from Feixiao's rotation`),
    ...
    },
    {
      ...
      content: [
        ...
        `benchmark.webp`,
        leaks(`The Characters tab now has a search bar, and filters for element / path`),
        leaks(`search.webp`),
        ...
        `combo.webp`,
        leaks(`Updated Yunli's default scoring team`),
        leaks(`yunli.webp`),
        leaks(`Updated Yunli and March 8th's Ashblazing set calcs`),
        ...
        leaks(`Balance: March 8th now uses S5 Cruising in the Stellar Sea for scoring`),
      ],
    },
    {
      title: '',
