  ...
  const changelog: ChangelogContent[] = [
    {
      ...
      content: [
        ...
        `rotation.webp`,
        `Added an Advanced Rotation panel for full customizability of buff uptime and in-battle conditional calculations`,
        ...
        `i18n.webp`,
        `Removed WEIGHT sort and filter option for optimizer simplification, the WEIGHT column still remains`,
        `Fix: Recommended presets no longer resets weighted rolls per relic`,
        `Balance: DPS score was overvaluing ATK boots in certain situations with large amount of speed buffs, mostly affects ATK boots Kafka S1 builds`,
