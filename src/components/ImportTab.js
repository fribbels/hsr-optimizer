    ...
    return (
      <Flex style={{minHeight: 250}}>
        <Flex vertical gap={10} style={{display: current >= 1 ? 'flex' : 'none'}}>
          ...
          <Divider/>
          <Text>
            Import relics and characters. <b> WARNING: This will overwrite your saved optimizer builds with your ingame builds! </b>
          </Text>
    ...
    <div style={{display: props.active ? 'block' : 'none'}}>
      <Flex vertical gap={5} style={{marginLeft: 20, width: 1200}}>
        <Tabs
          ...
          items={[
            {
              label: 'Kel-Z Scanner Importer',
              key: 0,
              children: kelZImporterTab(),
            },
            {
              label: 'Fribbels HSR Scanner Importer',
              key: 1,
