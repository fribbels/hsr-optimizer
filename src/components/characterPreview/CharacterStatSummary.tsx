...
export const CharacterStatSummary = (props: {
  ...
  return (
    <Flex vertical style={{ paddingLeft: 6, paddingRight: 8 }} gap={3}>
      ...
      {!props.showSimScoring && <StatRow finalStats={props.finalStats} stat={Constants.Stats.OHB}/>}
      ...
      {props.showSimScoring && <StatRow finalStats={props.finalStats} stat="simScore" value={props.simScore}/>}
    </Flex>
  )
}
