export function RingedCircleIcon({ color }: { color?: string }) {
  return (
    <svg viewBox='64 64 896 896' focusable='false' data-icon='circle' width='20' height='20' fill={color ?? 'transparent'} style={{ display: 'block' }}>
      <path
