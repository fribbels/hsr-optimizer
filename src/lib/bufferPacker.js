...
export const BufferPacker = {
  ...
  packCharacter: (arr, offset, character) => {
    ...
    arr[offset * SIZE + i++] = character.xHP
    arr[offset * SIZE + i++] = character.xATK
    arr[offset * SIZE + i++] = character.xDEF
    arr[offset * SIZE + i++] = character.xSPD
    arr[offset * SIZE + i++] = character.xCR
    arr[offset * SIZE + i++] = character.xCD
    arr[offset * SIZE + i++] = character.xEHR
    arr[offset * SIZE + i++] = character.xRES
    arr[offset * SIZE + i++] = character.xBE
    arr[offset * SIZE + i++] = character.xERR
    arr[offset * SIZE + i++] = character.xOHB
    arr[offset * SIZE + i++] = character.xED
  }
}