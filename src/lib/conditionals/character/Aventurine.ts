...
export default (e: Eidolon): CharacterConditional => {
  ...
  const content: ContentItem[] = [
    ...
    },
    {
      ...
      content: t('Content.1.content', { talentResScaling: TsUtils.precisionRound(100 * talentResScaling) }),
    },
    {
      formItem: 'switch',
      ...
      content: t('Content.2.content', { ultCdBoost: TsUtils.precisionRound(100 * ultCdBoost) }),
    },
    {
      formItem: 'slider',
      id: 'fuaHitsOnTarget',
      ...
      content: t('Content.3.content', { talentDmgScaling: TsUtils.precisionRound(100 * talentDmgScaling) }),
      min: 0,
      max: fuaHits,
    },
    {
