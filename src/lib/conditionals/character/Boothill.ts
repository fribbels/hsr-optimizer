...
export default (e: Eidolon): CharacterConditional => {
  ...
  return {
    ...
    calculateBaseMultis: (c: PrecomputedCharacterConditional, request: Form) => {
      ...
      x.BASIC_BREAK_DMG_MODIFIER += (r.talentBreakDmgScaling) ? inverseBreakToughnessMultiplier * newBreakToughnessMultiplier * talentBreakDmgScaling * r.pocketTrickshotStacks : 0
