...
export default (e: Eidolon, withoutContent: boolean): CharacterConditional => {
  ...
  const content: ContentItem[] = (() => {
    ...
    const t = i18next.getFixedT(null, 'conditionals', 'Characters.Robin.Content')
    return [
      {
        formItem: 'switch',
        id: 'concertoActive',
        name: 'concertoActive',
        text: t('concertoActive.text'),
        title: t('concertoActive.title'),
        content: t('concertoActive.content', { ultAtkBuffScalingValue: TsUtils.precisionRound(100 * ultAtkBuffScalingValue), ultAtkBuffFlatValue: ultAtkBuffFlatValue, ultScaling: TsUtils.precisionRound(100 * ultScaling) }),
      },
      {
        formItem: 'switch',
        id: 'skillDmgBuff',
        ...
        content: t('skillDmgBuff.content', { skillDmgBuffValue: TsUtils.precisionRound(100 * skillDmgBuffValue) }),
      },
      {
        formItem: 'switch',
        id: 'talentCdBuff',
        ...
        title: t('talentCdBuff.title'),
        content: t('talentCdBuff.content', { talentCdBuffValue: TsUtils.precisionRound(100 * talentCdBuffValue) }),
      },
      {
        formItem: 'switch',
        id: 'e1UltResPen',
        name: 'e1UltResPen',
        text: t('e1UltResPen.text'),
        title: t('e1UltResPen.title'),
        content: t('e1UltResPen.content'),
        disabled: e < 1,
      },
      {
        formItem: 'switch',
      ...
      },
      {
        ...
        id: 'e6UltCDBoost',
        name: 'e6UltCDBoost',
        text: t('e6UltCDBoost.text'),
        title: t('e6UltCDBoost.title'),
        content: t('e6UltCDBoost.content'),
        disabled: e < 6,
      },
    ]
  })()
  ...
  const teammateContent: ContentItem[] = (() => {
    if (withoutContent) return []
    const t = i18next.getFixedT(null, 'conditionals', 'Characters.Robin.TeammateContent')
    return [
      ...
      findContentId(content, 'skillDmgBuff'),
      {
        ...
        text: t('teammateATKValue.text'),
        title: t('teammateATKValue.title'),
        content: t('teammateATKValue.content', { ultAtkBuffFlatValue: TsUtils.precisionRound(100 * ultAtkBuffFlatValue), ultAtkBuffScalingValue: ultAtkBuffScalingValue }),
        min: 0,
        max: 7000,
      },
      findContentId(content, 'talentCdBuff'),
      {
        ...
        text: t('traceFuaCdBoost.text'),
        title: t('traceFuaCdBoost.title'),
        content: t('traceFuaCdBoost.content'),
      },
      findContentId(content, 'e1UltResPen'),
      {
        ...
        id: 'e2UltSpdBuff',
        name: 'e2UltSpdBuff',
        text: t('e2UltSpdBuff.text'),
        title: t('e2UltSpdBuff.title'),
        content: t('e2UltSpdBuff.content'),
        disabled: e < 2,
      },
    ]
  })()
