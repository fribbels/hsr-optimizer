...
export default (e: Eidolon, withContent: boolean): CharacterConditional => {
  ...
  const content: ContentItem[] = [
    {
      ...
      title: t('Content.skillDmgBuff.title', { Version: CURRENT_DATA_VERSION }),
      content: t('Content.skillDmgBuff.content', { Version: CURRENT_DATA_VERSION }),
    },
    {
      ...
      title: t('Content.talentCrBuffStacks.title', { Version: CURRENT_DATA_VERSION }),
      content: t('Content.talentCrBuffStacks.content', { Version: CURRENT_DATA_VERSION }),
      min: 0,
      max: e < 6 ? 1 : 3,
    },
    {
      ...
      title: t('Content.techniqueDmgBuff.title', { Version: CURRENT_DATA_VERSION }),
      content: t('Content.techniqueDmgBuff.content', { Version: CURRENT_DATA_VERSION }),
    },
    {
      formItem: 'switch',
      id: 'e1ResPen',
      name: 'e1ResPen',
      text: t('Content.e1ResPen.text'),
      title: t('Content.e1ResPen.title', { Version: CURRENT_DATA_VERSION }),
      content: t('Content.e1ResPen.content', { Version: CURRENT_DATA_VERSION }),
      disabled: e < 1,
    },
    {
      formItem: 'switch',
      id: 'e2SpdBuff',
      name: 'e2SpdBuff',
      text: t('Content.e2SpdBuff.text'),
      title: t('Content.e2SpdBuff.title', { Version: CURRENT_DATA_VERSION }),
      content: t('Content.e2SpdBuff.content', { Version: CURRENT_DATA_VERSION }),
      disabled: e < 2,
    },
  ]
  ...
  const teammateContent: ContentItem[] = [
    ...
    findContentId(content, 'talentCrBuffStacks'),
    {
      ...
      title: t('TeammateContent.beatified.title', { Version: CURRENT_DATA_VERSION }),
      content: t('TeammateContent.beatified.content', { Version: CURRENT_DATA_VERSION }),
    },
    {
      formItem: 'slider',
      id: 'teammateCDValue',
      ...
      title: t('TeammateContent.teammateCDValue.title', { Version: CURRENT_DATA_VERSION }),
      content: t('TeammateContent.teammateCDValue.content', { Version: CURRENT_DATA_VERSION }),
      min: 0,
      max: 3.00,
      percent: true,
    },
    ...
    findContentId(content, 'e2SpdBuff'),
    {
      ...
      title: t('TeammateContent.e6CrToCdConversion.title', { Version: CURRENT_DATA_VERSION }),
      content: t('TeammateContent.e6CrToCdConversion.content', { Version: CURRENT_DATA_VERSION }),
      disabled: e < 6,
    },
  ]
