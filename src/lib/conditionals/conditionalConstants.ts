...
export const baseComputedStatsObject = {
  ...
  RATIO_BASED_SPD_P_BUFF: 0,
  RATIO_BASED_CR_BUFF: 0,
  RATIO_BASED_CD_BUFF: 0,
  RATIO_BASED_EHR_BUFF: 0,
  RATIO_BASED_BE_BUFF: 0,
  RATIO_BASED_OHB_BUFF: 0,
  RATIO_BASED_RES_BUFF: 0,
  RATIO_BASED_ERR_BUFF: 0,
