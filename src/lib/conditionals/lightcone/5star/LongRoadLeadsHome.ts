...
export default (s: SuperImpositionLevel, withContent: boolean): LightConeConditional => {
  ...
  const content: ContentItem[] = [{
    ...
    title: t('Content.breakVulnerabilityStacks.title', { Version: CURRENT_DATA_VERSION }),
    content: t('Content.breakVulnerabilityStacks.content', { Version: CURRENT_DATA_VERSION }),
    min: 0,
    max: 2,
  }]
