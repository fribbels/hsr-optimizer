...
const conditionals = (s: SuperImpositionLevel, withContent: boolean): LightConeConditionalsController => {
  const t = wrappedFixedT(withContent).get(null, 'conditionals', 'Lightcones.ToEvernightsStars.Content')
  ...
  const content: ContentDefinition<typeof defaults> = {
    defPen: {
      ...
      formItem: 'switch',
      text: t('defPen.text'),
      content: t('defPen.content', { MemoDefPen: precisionRound(100 * sValuesDefPen[s]) }),
    },
    dmgBoost: {
      lc: true,
      id: 'dmgBoost',
...
export const ToEvernightsStars: LightConeConfig = {
  id: '23049',
  conditionals,
}
