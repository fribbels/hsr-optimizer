...
export type DynamicConditional = {
  ...
  activation: number
  dependsOn: string[]
  condition: (x: ComputedStatsArrayCore, action: OptimizerAction, context: OptimizerContext) => boolean | number
  effect: (x: ComputedStatsArrayCore, action: OptimizerAction, context: OptimizerContext) => void
...
export function evaluateConditional(conditional: DynamicConditional, x: ComputedStatsArrayCore, action: OptimizerAction, context: OptimizerContext) {
...
export function buffDynamicStat(x: ComputedStatsArrayCore, stat: string, value: number, action: OptimizerAction, context: OptimizerContext) {
...
export const AventurineConversionConditional: DynamicConditional = {
  ...
  dependsOn: [Stats.DEF],
  condition: function (x: ComputedStatsArrayCore, action: OptimizerAction, context: OptimizerContext) {
    const r = action.characterConditionals
    return r.defToCrBoost && x[Stats.DEF] > 1600
  },
  effect: function (x: ComputedStatsArrayCore, action: OptimizerAction, context: OptimizerContext) {
