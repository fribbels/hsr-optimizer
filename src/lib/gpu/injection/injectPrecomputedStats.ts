...
import { Source } from 'lib/optimizer/computedStatsArray'
...
export function injectPrecomputedStatsContext(action: OptimizerAction, gpuParams: GpuConstants) {
  ...
  const computedStatsWgsl = `
      ${x.$HP_P},${gpuParams.DEBUG ? ' // Stats.HP_P' : ''}
      ${x.$ATK_P},${gpuParams.DEBUG ? ' // Stats.ATK_P' : ''}
      ${x.$DEF_P},${gpuParams.DEBUG ? ' // Stats.DEF_P' : ''}
      ${x.$SPD_P},${gpuParams.DEBUG ? ' // Stats.SPD_P' : ''}
      ${x.$HP},${gpuParams.DEBUG ? ' // Stats.HP' : ''}
      ${x.$ATK},${gpuParams.DEBUG ? ' // Stats.ATK' : ''}
      ${x.$DEF},${gpuParams.DEBUG ? ' // Stats.DEF' : ''}
      ${x.$SPD},${gpuParams.DEBUG ? ' // Stats.SPD' : ''}
      ${x.$CR},${gpuParams.DEBUG ? ' // Stats.CR' : ''}
      ${x.$CD},${gpuParams.DEBUG ? ' // Stats.CD' : ''}
      ${x.$EHR},${gpuParams.DEBUG ? ' // Stats.EHR' : ''}
      ${x.$RES},${gpuParams.DEBUG ? ' // Stats.RES' : ''}
      ${x.$BE},${gpuParams.DEBUG ? ' // Stats.BE' : ''}
      ${x.$ERR},${gpuParams.DEBUG ? ' // Stats.ERR' : ''}
      ${x.$OHB},${gpuParams.DEBUG ? ' // Stats.OHB' : ''}
      ${x.$PHYSICAL_DMG_BOOST},${gpuParams.DEBUG ? ' // Stats.Physical_DMG' : ''}
      ${x.$FIRE_DMG_BOOST},${gpuParams.DEBUG ? ' // Stats.Fire_DMG' : ''}
      ${x.$ICE_DMG_BOOST},${gpuParams.DEBUG ? ' // Stats.Ice_DMG' : ''}
      ${x.$LIGHTNING_DMG_BOOST},${gpuParams.DEBUG ? ' // Stats.Lightning_DMG' : ''}
      ${x.$WIND_DMG_BOOST},${gpuParams.DEBUG ? ' // Stats.Wind_DMG' : ''}
      ${x.$QUANTUM_DMG_BOOST},${gpuParams.DEBUG ? ' // Stats.Quantum_DMG' : ''}
      ${x.$IMAGINARY_DMG_BOOST},${gpuParams.DEBUG ? ' // Stats.Imaginary_DMG' : ''}
