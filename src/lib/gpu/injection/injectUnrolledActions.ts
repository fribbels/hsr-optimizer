...
fn unrolledAction${index}(
  ...
  if (
    op2(*p_sets, SET_CelestialDifferentiator) >= 1
  ...
  if (rp4(*p_sets, SET_PoetOfMourningCollapse) >= 1) {
  ...
  if (rp4(*p_sets, SET_DivinerOfDistantReach) >= 1) {
  ...
  if (
    rp4(*p_sets, SET_MessengerTraversingHackerspace) >= 1
  ...
  if (
    rp4(*p_sets, SET_HeroOfTriumphantSong) >= 1
  ...
  if (
    rp4(*p_sets, SET_WarriorGoddessOfSunAndThunder) >= 1
  ...
  if (
    op2(*p_sets, SET_AmphoreusTheEternalLand) >= 1
  ...
  if (
    rp4(*p_sets, SET_WorldRemakingDeliverer) >= 1
  ...
  if (rp2(*p_sets, SET_PioneerDiverOfDeadWaters) >= 1 && setConditionals.valuePioneerDiverOfDeadWaters >= 0) {
    ${buff.action(AKey.DMG_BOOST, 0.12).wgsl(action, 2)}
    if (rp4(*p_sets, SET_PioneerDiverOfDeadWaters) >= 1) {
  ...
  if (op2(*p_sets, SET_SigoniaTheUnclaimedDesolation) >= 1) {
    ${buff.action(AKey.CD, `0.04 * f32(setConditionals.valueSigoniaTheUnclaimedDesolation)`).wgsl(action, 2)}
  }

  if (op2(*p_sets, SET_DuranDynastyOfRunningWolves) >= 1) {
  ...
  if (rp4(*p_sets, SET_LongevousDisciple) >= 1) {
    ${buff.action(AKey.CR, `0.08 * f32(setConditionals.valueLongevousDisciple)`).wgsl(action, 2)}
  }

  if (
    op2(*p_sets, SET_IzumoGenseiAndTakamaDivineRealm) >= 1
  ...
  if (
    rp4(*p_sets, SET_WatchmakerMasterOfDreamMachinations) >= 1
  ...
  if (
    op2(*p_sets, SET_ForgeOfTheKalpagniLantern) >= 1
  ...
  if (rp4(*p_sets, SET_MusketeerOfWildWheat) >= 1) {
    ${buff.hit(HKey.DMG_BOOST, 0.10).damageType(DamageTag.BASIC).wgsl(action, 2)}
  }

  if (rp4(*p_sets, SET_FiresmithOfLavaForging) >= 1) {
  ...
  if (op2(*p_sets, SET_ArcadiaOfWovenDreams) >= 1) {
  ...
  if (rp2(*p_sets, SET_SelfEnshroudedRecluse) >= 1) {
    ${buff.hit(HKey.DMG_BOOST, 0.10).outputType(OutputTag.SHIELD).wgsl(action, 2)}
    if (rp4(*p_sets, SET_SelfEnshroudedRecluse) >= 1) {
  ...
  if (
    op2(*p_sets, SET_FirmamentFrontlineGlamoth) >= 1
  ...
  if (
    op2(*p_sets, SET_RutilantArena) >= 1
  ...
  if (
    op2(*p_sets, SET_InertSalsotto) >= 1
  ...
  if (op2(*p_sets, SET_RevelryByTheSea) >= 1) {
  ...
  if (
    rp4(*p_sets, SET_IronCavalryAgainstTheScourge) >= 1
