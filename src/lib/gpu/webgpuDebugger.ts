...
export function debugWebgpuComputedStats(array: Float32Array): ComputedStatsObject {
  return {
    ...
    DOT_STACKS: array[81],
    SUMMONS: array[82],
    ENEMY_WEAKNESS_BROKEN: array[83],
    SUPER_BREAK_MODIFIER: array[84],
    BASIC_SUPER_BREAK_MODIFIER: array[85],
    SUPER_BREAK_HMC_MODIFIER: array[86],
    BASIC_TOUGHNESS_DMG: array[87],
    SKILL_TOUGHNESS_DMG: array[88],
    ULT_TOUGHNESS_DMG: array[89],
    FUA_TOUGHNESS_DMG: array[90],
    BASIC_ORIGINAL_DMG_BOOST: array[91],
    SKILL_ORIGINAL_DMG_BOOST: array[92],
    ULT_ORIGINAL_DMG_BOOST: array[93],
    BASIC_BREAK_DMG_MODIFIER: array[94],
    ULT_CD_OVERRIDE: array[95],
    ULT_BOOSTS_MULTI: array[96],
    RATIO_BASED_HP_BUFF: array[97],
    RATIO_BASED_HP_P_BUFF: array[98],
    RATIO_BASED_ATK_BUFF: array[99],
    RATIO_BASED_ATK_P_BUFF: array[100],
    RATIO_BASED_DEF_BUFF: array[101],
    RATIO_BASED_DEF_P_BUFF: array[102],
    RATIO_BASED_SPD_BUFF: array[103],
    RATIO_BASED_CD_BUFF: array[104],
    BREAK_EFFICIENCY_BOOST: array[105],
    BASIC_BREAK_EFFICIENCY_BOOST: array[106],
    ULT_BREAK_EFFICIENCY_BOOST: array[107],
    BASIC_DMG_TYPE: array[108],
    SKILL_DMG_TYPE: array[109],
    ULT_DMG_TYPE: array[110],
    FUA_DMG_TYPE: array[111],
    DOT_DMG_TYPE: array[112],
    BREAK_DMG_TYPE: array[113],
    SUPER_BREAK_DMG_TYPE: array[114],
