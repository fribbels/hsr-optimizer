...
struct ComputedStats {
  ...
  RATIO_BASED_SPD_P_BUFF: f32,
  RATIO_BASED_CR_BUFF: f32,
  RATIO_BASED_CD_BUFF: f32,
  RATIO_BASED_EHR_BUFF: f32,
  RATIO_BASED_BE_BUFF: f32,
  RATIO_BASED_OHB_BUFF: f32,
  RATIO_BASED_RES_BUFF: f32,
  RATIO_BASED_ERR_BUFF: f32,
