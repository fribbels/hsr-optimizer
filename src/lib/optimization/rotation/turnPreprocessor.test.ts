...
test('Anaxa unannotated', () => {
  expect(compareAbilityNameArrays(
    ...
    [
      NULL_TURN_ABILITY_NAME, START_ULT, END_SKILL, WHOLE_SKILL, WHOLE_SKILL, WHOLE_SKILL,
    ],
  )).toBeTruthy()
})
...
test('Complex invalid rotation', () => {
  expect(compareAbilityNameArrays(
    ...
    [
      NULL_TURN_ABILITY_NAME, START_FUA, END_SKILL, DEFAULT_MEMO_SKILL, START_ULT, DEFAULT_FUA, DEFAULT_SKILL, DEFAULT_MEMO_TALENT, DEFAULT_ULT,
...
test('Complex invalid rotation 2', () => {
  expect(compareAbilityNameArrays(
    ...
    [
      NULL_TURN_ABILITY_NAME, START_ULT, DEFAULT_ULT, DEFAULT_SKILL, DEFAULT_ULT, END_BASIC, START_SKILL, DEFAULT_MEMO_SKILL, END_ULT, DEFAULT_FUA, DEFAULT_MEMO_TALENT,
