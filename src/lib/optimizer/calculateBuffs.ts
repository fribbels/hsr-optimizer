...
export function _buffAbilityVulnerability(x: ComputedStatsArray, abilityTypeFlags: number, value: number, source: string) {
  if (abilityTypeFlags & x.$BASIC_DMG_TYPE) x.BASIC_VULNERABILITY.buff(value, source)
  if (abilityTypeFlags & x.$SKILL_DMG_TYPE) x.SKILL_VULNERABILITY.buff(value, source)
  if (abilityTypeFlags & x.$ULT_DMG_TYPE) x.ULT_VULNERABILITY.buff(value, source)
  if (abilityTypeFlags & x.$FUA_DMG_TYPE) x.FUA_VULNERABILITY.buff(value, source)
  if (abilityTypeFlags & x.$DOT_DMG_TYPE) x.DOT_VULNERABILITY.buff(value, source)
  if (abilityTypeFlags & x.$BREAK_DMG_TYPE) x.BREAK_VULNERABILITY.buff(value, source)
  // No super break
}
...
export function _buffAbilityResPen(x: ComputedStatsArray, abilityTypeFlags: number, value: number, source: string) {
  if (abilityTypeFlags & x.$BASIC_DMG_TYPE) x.BASIC_RES_PEN.buff(value, source)
  if (abilityTypeFlags & x.$SKILL_DMG_TYPE) x.SKILL_RES_PEN.buff(value, source)
  if (abilityTypeFlags & x.$ULT_DMG_TYPE) x.ULT_RES_PEN.buff(value, source)
  if (abilityTypeFlags & x.$FUA_DMG_TYPE) x.FUA_RES_PEN.buff(value, source)
  if (abilityTypeFlags & x.$DOT_DMG_TYPE) x.DOT_RES_PEN.buff(value, source)
  // No break
}
...
export function _buffAbilityDefPen(x: ComputedStatsArray, abilityTypeFlags: number, value: number, source: string) {
  if (abilityTypeFlags & x.$BASIC_DMG_TYPE) x.BASIC_DEF_PEN.buff(value, source)
  if (abilityTypeFlags & x.$SKILL_DMG_TYPE) x.SKILL_DEF_PEN.buff(value, source)
  if (abilityTypeFlags & x.$ULT_DMG_TYPE) x.ULT_DEF_PEN.buff(value, source)
  if (abilityTypeFlags & x.$FUA_DMG_TYPE) x.FUA_DEF_PEN.buff(value, source)
  if (abilityTypeFlags & x.$DOT_DMG_TYPE) x.DOT_DEF_PEN.buff(value, source)
  if (abilityTypeFlags & x.$BREAK_DMG_TYPE) x.BREAK_DEF_PEN.buff(value, source)
  if (abilityTypeFlags & x.$SUPER_BREAK_DMG_TYPE) x.SUPER_BREAK_DEF_PEN.buff(value, source)
}
...
export function _buffAbilityCr(x: ComputedStatsArray, abilityTypeFlags: number, value: number, source: string) {
  if (abilityTypeFlags & x.$BASIC_DMG_TYPE) x.BASIC_CR_BOOST.buff(value, source)
  if (abilityTypeFlags & x.$SKILL_DMG_TYPE) x.SKILL_CR_BOOST.buff(value, source)
  if (abilityTypeFlags & x.$ULT_DMG_TYPE) x.ULT_CR_BOOST.buff(value, source)
  if (abilityTypeFlags & x.$FUA_DMG_TYPE) x.FUA_CR_BOOST.buff(value, source)
  // No dot, break
}
...
export function _buffAbilityCd(x: ComputedStatsArray, abilityTypeFlags: number, value: number, source: string) {
  if (abilityTypeFlags & x.$BASIC_DMG_TYPE) x.BASIC_CD_BOOST.buff(value, source)
  if (abilityTypeFlags & x.$SKILL_DMG_TYPE) x.SKILL_CD_BOOST.buff(value, source)
  if (abilityTypeFlags & x.$ULT_DMG_TYPE) x.ULT_CD_BOOST.buff(value, source)
  if (abilityTypeFlags & x.$FUA_DMG_TYPE) x.FUA_CD_BOOST.buff(value, source)
  // No dot, break
}
