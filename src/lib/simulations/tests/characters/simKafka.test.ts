...
import { expectWithinDelta, testStatSpread } from 'lib/simulations/tests/statSimTestUtils'
...
function initializeBaseRequest() {
  const form = generateFullDefaultForm(KAFKA, LC, 6, 5)
