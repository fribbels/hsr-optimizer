  ...
  const changelog: ChangelogContent[] = [
    {
      ...
      content: [
        ...
        `Showcase card color adjustments for various characters`,
        `dark.webp`,
        `Content has been updated for version 3.0`,
        `Added Memosprite handling logic for remembrance characters`,
        `Optimizer sidebar now has a Summoner / Memosprite stats view selector`,
        `memoView.webp`,
        ...
        `Showcase Damage Improvements tab now shows Elemental + Ability DMG as "DMG %" to not overflow space`,
        ...
        `— We're adjusting this free score to be a flat 1 substat roll for all main stats, which will result in a slight Character / Relic score decrease`,
