...
export function getChangelogContent() {
  const changelog: ChangelogContent[] = [
    ...
    },
    {
      ...
      date: '2026-05-26',
      content: [
        `Added Support Benchmarks for Bronya, Robin, Sparkle, Sunday, Cerydra, Permansor Terrae, Trailblazer Harmony, and Trailblazer Remembrance`,
        `support.webp`,
        `Added Heal Benchmarks for Lynx, Natasha, Bailu, Fu Xuan, Huohuo B1, Lingsha, Luocha, and Hyacine`,
        `heal.webp`,
        `Added Shield Benchmarks for March 7th, Gepard, Aventurine, and Trailblazer Preservation`,
        `shield.webp`,
        ...
        `Fix: Cyrene E1 extra bounces no longer apply at E0`,
        `Fix: Mortenax Blade scoring now supports ERR rope correctly`,
      ],
    },
    {
      title: '',
