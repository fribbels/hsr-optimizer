  ...
  const changelog: ChangelogContent[] = [
    ...
    },
    {
      ...
      content: [
        ...
        `leaderboard.webp`,
        `Leaderboard entries show rank, benchmark %, and substat roll quality`,
        `detail.webp`,
        ...
        `timeline.webp`,
        `Added AEON relic rating tier (90%+) for verified relics with default scoring weights`,
        `Added Live2D character models for 4.4 characters`,
        `Added browser forward/backward navigation support`,
        `Flat stats for support characters on pieces where the main stat is already the percent stat now have 100% value in relic scores for support characters`,
        `Added Cerydra's Peerage teammate preprocessor`,
        `Sub-DPS characters now default to Main DPS showcase mode when the team has no other DPS teammate`,
        `Fix: Fugue now has correct toughness damage values on Basic and Ult`,
        `Fix: Light cone conditional scaling for Thus Burns the Dawn, Yet Hope Is Priceless, and In the Name of the World`,
        `Fix: HoyoLab import mappings added for Remembrance and Elation Trailblazer variants`,
        `Balance: Updated Benchmark score default teams for multiple characters`,
        `Balance: Mortenax Blade now matches Guard of Wuthering Snow relic set in benchmarks`,
        `Balance: Updated Robin support simulation to default to Lushaka ornament set`,
        `Balance: Updated support benchmarks diminishing returns formulas - in general support scores will be increased`,
        `Balance: Removed Aventurine DPS Benchmarks`,
      ],
    },
    {
      title: '',
      date: '2026-06-06',
      content: [
        `Substat Rolls view for showcasing and counting individual substat rolls and their quality`,
        `rolls.webp`,
        ...
        `grade.webp`,
        `Added new Multi Target mode for the Warp Planner tab`,
        `warp.webp`,
        `Fix: The Dahlia's Break Effect conversion for teammates is now gated by having a sustain on the team`,
        `Balance: Adjusted character weights for percentage grading`,
        `Asta, Himeko, Sushang, TB Destruction`,
        `- BE 0.5 -> 0`,
        `March 7th, Gepard, TB Preservation`,
        `- HP 0.25 -> 0`,
        `Natasha, Lynx, Bailu, Huohuo`,
        `- DEF 0.25 -> 0`,
        `SilverWolf`,
        `- RES 0.25 -> 0`,
        `Bronya,  Sparkle, Sunday, Robin, Ruan Mei, TB Harmony, TB Remembrance, Cerydra, Permansor Terrae, Silverwolf, Jiaoqiu, Gallagher, Lingsha, Luocha`,
        `- HP, DEF 0.25 -> 0`,
        `Balance: SPD substats weights are now renormalized to 0.8/0.9/1.0 quality, matching the other stats`,
      ],
    },
    {
      title: '',
    ...
    },
    {
      ...
      content: [
        ...
        `shield.webp`,
        `Benchmarks now show a 0% along with 100% / 200% for all for DPS and Support / Heal / Shield, and the primary measurement stat`,
        `bench.webp`,
        `Added Combo Heal, Combo Shield, and Buff optimization targets with reorganized target categories`,
        `targets.webp`,
        `Updated Sacerdos set conditioanls to separate incoming CD buffs from outgoing CD buffs`,
        `Updated Lushaka to default-enabled with ATK buff included in support scoring`,
        `sacerdos.webp`,
        `Added Mortenax Blade E2 Ashblazing presets with teammate-aware conditionals`,
        `Added Ashblazing Grand Duke multi-hit stack calculations for ults`,
        `ashblazingult.webp`,
        `Remove pre-novaflare character variants scoring`,
        `Remove Trailblazer Elation's DPS Benchmark scoring`,
        `Fix: Updated Ashveil enhanced FUA Ashblazing stack calculations`,
        `Fix: Cyrene E1 extra bounces are now correctly gated by eidolon`,
        `Fix: Mortenax Blade scoring now supports ERR rope`,
      ],
    },
    {
      title: '',
      date: '2026-05-12',
      content: [
        `Updated content to 4.3v3`,
        `Aha Speed Tuning - visualizes teammate SPD contribution and computes solves for SPD thresholds for Aha breakpoints`,
        `aha.webp`,
        `EHR Calculator - shows debuff application probability across EHR and Effect RES values`,
        `ehr.webp`,
        `The new Calculators tab is added to the sidebar`,
        `side.webp`,
        `DPS Score analysis now includes teammate relic/ornament set upgrade damage potential`,
        `upgrade1.webp`,
        `Upgrade table shows potential Combo DMG increase from switching teammate sets, available in both the character showcase and optimizer expanded analysis panel`,
        `upgrade2.webp`,
        `Live import scanner now supports a toggle to only update characters already in your roster`,
        `live.webp`,
        `Screenshots now export as WebP at 2x DPR for sharper quality and smaller file sizes on supported devices`,
        `Character delete confirmation dialog now accepts the Enter key`,
        `Fix: Updated warp planner documentation with expanded sections and clearer descriptions`,
        `Fix: Benchmark CR and EHR roll caps now use the correct baseline when candidate pool sets differ from default metadata sets`,
        `Fix: Screenshots not working on Firefox and Safari - falls back to PNG when WebP clipboard is not supported`,
        `Fix: Custom portrait screenshots now fall to default portrait when cross-origin images are blocked by CORS`,
        `Fix: Sparxie ATK → Elation and Yaoguang SPD → Elation conversions now produce convertible Elation instead of unconvertible`,
        `Fix: Relic substat order is now preserved on import - the game no longer sorts substats following the addition of preview substats`,
        `Fix: Est. TBP returning finite values for impossible relics - roll grading is now uncapped when substat values exceed what the assigned roll count can produce`,
        `Fix: Relic roll display caps at maximum real values to prevent visual overflow for impossible relics`,
        `Fix: Stat simulation results now pre-sort correctly before populating the grid`,
        `Fix: Trailblazer (Elation) E2 ultimate buff now correctly targets a single target and defaults to disabled on themselves`,
        `Balance: Wavestrider Captain, Poet of Mourning Collapse, and Pioneer Diver of Dead Waters removed from adaptive set matching for most characters`,
        `Balance: Evanescia default SPD scoring weight changed to 0`,
      ],
    },
    {
      title: '',
      ...
      content: [
        ...
        `blade.webp`,
        `Added As Navigator Isee Sees It / Divine-Querying Master Smith relic sets`,
        `sets.webp`,
        `Scoring columns now display the simulation's relic/ornament sets inline — the old separate "Simulation Sets" section was removed`,
        `Adaptive DPS scoring set matching lets benchmarks match the user's selected set values if it improves damage over the preset relics`,
        `May result in DPS Score decreasing for certain characters that were benchmarking against weaker sets`,
        `adaptive.webp`,
        `Restored Extra Combat Buffs drawer`,
        `buffs.webp`,
        `New "Default rank for new characters" setting to choose whether newly added characters go to highest priority (Rank #1) or lowest priority`,
        `setting.webp`,
        `Show/Hide Live2D toggle in the showcase customization sidebar`,
        `hide.webp`,
        `Save data automatically migrates unbuffed characters when Novaflare upgrades release`,
        `Default teams updated for Novaflare characters`,
        `Screenshot buttons fixed on mobile, updated showcase font`,
        `Buffs analysis filter pills now toggle off when re-clicked`,
        `Live2D animations now pause on window/tab switches, performance improved`,
        `Fix: Silver Wolf LV.999 SPD -> Elation conversion now floors intermediate values for correct granularity`,
        `Fix: Saved builds preview now uses the saved light cone instead of currently equipped`,
        `Fix: Recommended presets now properly reset character/LC/teammate conditionals`,
        `Fix: GPU basic stat filters no longer incorrectly applied in non-combat display mode`,
        `Fix: Optimizer row click selection now works consistently`,
        `Fix: Relic roll grader overcounting bug fixed`,
        `Fix: Optimizer permutation count now accurately reflects the possible count after set filtering`,
        `Fix: Web Workers now use IIFE format for broader browser compatibility`,
      ],
    },
    {
      title: '',
      date: '2026-04-19',
      content: [
        `Updated content to 4.2v5`,
        `The entire UI has been redesigned for better usability`,
        `Added Live2D character portraits`,
        `l2d.webp`,
        `Redesigned homepage with feature cards`,
        `homepage.webp`,
        `New redesigned drag-and-drop Character tab list`,
        `characterlist.webp`,
        ...
        `analysis.webp`,
        `Updated Combo DMG comparison warning with clearer explanations and confirmation`,
        `disclaimer.webp`,
        `Updated color pipeline for character card backgrounds`,
        `color.webp`,
        ...
        `Fix: Silver Wolf Lv.999 E1 Vulnerability not applying as teammate buff and corrected SPD to Elation thresholds`,
        `Fix: Welt E6 crit bonuses not applying to Additional DMG from Skill/Ultimate`,
        `Fix: Permansor Terrae calculations fixed on CPU mode`,
        `Fix: Scoring weights correctly update with default changes now`,
      ],
    },
    {
      title: '',
    ...
    },
    {
      ...
      content: [
        ...
        'Elation DMG calculations are now enabled',
        'Added Sparxie DPS score',
        'sparxie.webp',
        'Added Yaoguang DPS score',
        'yaoguang.webp',
        'Added Ever-Glorious Magical Girl and Diviner of Distant Reach sets',
        'sets.webp',
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        `teammates.webp`,
        `These can be chosen from the teammate selector`,
        `select.webp`,
        `Added disclaimers to not compare Combo DMG across different teams`,
        `disclaimer.webp`,
        ...
        `Balance: Adding Tengoku@Livestream as matched sets for the following characters:`,
        `— Seele, Archer, Qingque, Dan Heng • Imbibitor Lunae`,
        `Balance: Adding Self-Enshrouded Recluse as a matched set for Aventurine`,
      ],
    },
    {
      title: '',
      ...
      content: [
        ...
        `Balance: Anaxa now has Forge of the Kalpagni Lantern conditional enabled by default`,
        `Balance: Saber and Evernight now have ERR rope matched by default`,
    ...
    },
    {
      ...
      content: [
        ...
        `To use this, run the scanner with the stream flag: reliquary-archiver_x64.exe --stream`,
        `stream.webp`,
        ...
        `This is now updated to always generate the optimal distribution, which will slightly nerf DPS Scores on characters that were affected`,
        `Added automatic resizing for custom portraits on DPS Score view, so the cropped art is no longer hidden by the light cone card`,
        `Unbuffed Novaflare characters will automatically be detected from the showcase`,
        `Fix: Hysilens 100% benchmark wasn't reaching the 120% EHR breakpoint in certain cases`,
        `Fix: The sidebar is now scrollable on small screens`,
        `Balance: Kafka is now defaulted to Sub DPS`,
        `Balance: Enabled Bronya's E2 SPD buff by default`,
      ],
    },
    {
      title: '',
      ...
      content: [
        ...
        `grey.webp`,
        `Added new Revelry by the Sea and Arcadia of Woven Dreams sets`,
        `sets.webp`,
        `Added Spanish (es_ES) translations to the site`,
        `es.webp`,
        `Added the Relic Locator to the Edit Relic popup, which can be enabled from the Settings tab`,
        `locator.webp`,
        `Showcase screenshot downloads are now correctly named based on character name`,
        `Removed Combo DMG displaying as "0.0K" from support showcase cards`,
        `Flame of Blood, Blaze My Path light cone now correctly applies the additionally increased DMG boost dynamically based on HP`,
        `The GPU optimizer permutation limit is now increased to 9007199254740992`,
    ...
    },
    {
      ...
      content: [
        ...
        `Added a new Benchmark Generator tab`,
        ...
        `benchmark.webp`,
        `Updated Combo DMG rotations to handle turn-based abilities. This allows calculations to handle turn based buff uptime for relic sets and future characters`,
        `BREAK is now considered a discrete action and can be added to the rotation`,
        `DOTs can also be added to the rotation, however the number of DOTs instances are now evenly distributed across the DOT abilities for calculating buff uptime`,
        `comboFilter.webp`,
        `Ability selectors are now updated to include turn start/end markers`,
        `turnMarkers.webp`,
        `The Advanced Combo rotations menu has been updated with the new turn based abilities and new turn-based presets for a few characters / sets`,
        `advanced.webp`,
        `Added two new sets: Warrior Goddess of Sun and Thunder, Wavestrider Captain`,
        `sets.webp`,
        ...
        `Fix: The 200% benchmark was incorrectly assuming that the body choice by the 100% benchmark was optimal. It will now choose the actual optimal body stat`,
        `Fix: The Reroll Potential measurement now assumes mid rolls instead of high rolls`,
        `Balance: Default enemy Effect RES has been changed from 20% -> 30%`,
        `Balance: Herta now has ERR rope allowed by default`,
        `Balance: Gallagher's skill is now disabled on himself by default`,
        `Balance: Argenti now defaults to using unenhanced Ult`,
        `Balance: March 7th Hunt now correctly only buffs the primary DPS`,
    ...
    },
    {
      ...
      date: '2025-04-07',
      content: [
        `Updated content to v3.3v1`,
        `Added Cipher showcase`,
        `cipher.webp`,
        `Added Hyacine showcase`,
        `hyacine.webp`,
    ...
    },
    {
      ...
      content: [
        ...
        `announce.webp`,
        `Changed Buff Priority: High / Low selector to be Dps Mode: Main / Sub`,
        `mode.webp`,
        ...
        `— RES weights for sustains are now set to 0.50 by default`,
        `— DPS changes: Anaxa's ATK% weight is updated to 1.00 to closer match his damage scaling`,
        `— DPS changes: Aglaea's ATK% weight is updated to 0.50 due to her passive ATK buff oversaturation`,
        `— DPS changes: Tribbie's HP% weight is updated to 1.00 for her damage scaling`,
        `— Destruction`,
        `destruction.webp`,
        `— Hunt`,
        `hunt.webp`,
    ...
    },
    {
      ...
      date: '2025-03-10',
      content: [
        `Updated content to 3.2v3`,
        `Added a DPS Score progress meter to visualize the scoring benchmarks and the damage increments between them`,
        `meter.webp`,
        `Updated main stat / substat upgrade tables on the DPS Score analysis page`,
        `The main stat upgrades now show the damage difference on downgrades as well`,
        `upgrade.webp`,
        `Updated warp income options to v3.2`,
        `income.webp`,
        `Added a New / Rerun banner selector to the Warp Planner page`,
        `When Rerun is selected, the current eidolon and superimposition options are shown`,
        `rerun.webp`,
        `Optimizer stat upgrades are now shown as an additional max stat roll instead of min roll`,
        `maxRoll.webp`,
        `Added a new Relics tab column for Reroll average delta potential vs currently equipped relics`,
        `This column can be used to sort by the most likely upgrades to a character's current relics`,
        `vs.webp`,
        `The Combat buffs menu will now show ability scalings by the scaling stat`,
        `scaling.webp`,
        `Relic displays will now accurately show previously ambiguous roll counts on relics verified by the Showcase page or Reliquary Archiver`,
        `roll.webp`,
        `Toughness measurement displays are now updated to 10 per basic atk instead of 30 per basic atk, no functional changes`,
        `Selecting Trailblazers on character menus will now default to E6`,
        `Improved performance of GPU optimization engine`,
        `Improved performance of CPU optimization engine on Firefox`,
        `Light cone effects will no longer activate when its path is mismatched with the character`,
        `Fix: Acheron's trace will now automatically update based on the number of Nihility teammates`,
        `Fix: Sparkle's trace will now automatically update based on the number of Quantum teammates`,
        `Fix: The Herta's trace will now automatically update based on the number of Erudition teammates`,
        `Fix: Poised To Bloom light cone will now automatically update based on teammates' paths`,
        `Fix: Izumo Gensei and Takama Divine Realm set will automatically update based on teammates' paths`,
        `Fix: On-Hit ATK / CR / CD boosting abilities will now no longer count towards filters and conditional activations, e.g. Ruan Mei E2, Acheron's E1`,
        `Fix: E6 Sparkle now correctly buffs memosprites`,
        `Fix: Penacony, Land of the Dreams set will now correctly buff the wearer's memosprite`,
        `Fix: Rappa's break vulnerability now correctly applies to memosprites`,
        `Fix: Long Road Leads Home light cone break vulnerability now correctly applies to memosprites`,
        `Fix: Buff priority no longer disables Castorice and her memosprite's self buffs`,
        `Fix: Clicking substat upgrades on the Edit Relic menu will now upgrade to the nearest 3, instead of adding 3`,
        `Balance: Mydei's benchmark now defaults to Bone Collection's Serene Demesne set`,
        `Balance: Acheron's simulated benchmarks can now also optimize with ATK % body`,
      ],
    },
    {
      title: '',
