...
export function ReliquaryDescription() {
      ...
      <li>
        ...
        <ul>
          {RELIQUARY_DOWNTIME
            ? (
              <li>
                <b style={{ color: '#ffaa4f' }}>{t('OfflineMsg', { version: DOWNTIME_VERSION })}</b>
              </li>
            )
            : (
              <li>
                <b style={{ color: '#82e192' }}>{t('OnlineMsg', { version: DOWNTIME_VERSION })}</b>
              </li>
            )}
