...
import { RelicSetTagRenderer } from 'lib/tabs/tabOptimizer/optimizerForm/RelicSetTagRenderer'
import GenerateSetsOptions from 'lib/tabs/tabOptimizer/optimizerForm/SetsOptions'
