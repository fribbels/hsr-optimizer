interface Resources {
  ...
  charactersTab: {
    ...
    CharacterPreview: {
      ...
      'BuildAnalysis': {
        ScoringNote:
          'DPS Score rates build quality by comparing an ability rotation\'s damage to benchmark builds with the same team / lightcones / eidolons. Scores and Combo DMG are measured relative only to the chosen team setup, and should not be compared across different configurations.',
        RelicRarityHeader: 'Relic rarity upgrade comparisons',
        RelicRarityNote:
          'Estimated TBP measures the expected farming time in Days and Trailblaze Power required to upgrade each relic based on the character\'s stat weights.\nThis is a metric of statistical rarity for farming prioritization, and does not reflect nor have an impact on DPS Score and Combo DMG.',
      ...
      AGroundedAscent: {
        Content: {
          dmgBuffStacks: {
            ...
            content:
              'After the wearer uses Skill or Ultimate on one ally character, the ability\'s target receives 1 stack of "Hymn" for 3 turns, stacking up to 3 times. Each stack of "Hymn" increases its holder\'s DMG dealt by {{DmgBuff}}%.',
          },
        },
      },
      AlongThePassingShore: {
        Content: {
          emptyBubblesDebuff: {
            ...
            content:
              'When the wearer hits an enemy target, inflicts Mirage Fizzle on the enemy, lasting for 1 turn. Each time the wearer attacks, this effect can only trigger 1 time on each target. The wearer deals {{DmgBoost}}% increased DMG to targets afflicted with Mirage Fizzle, and the DMG dealt by the wearer\'s Ultimate additionally increases by {{UltDmgBoost}}%.',
          },
        },
      },
      AnInstantBeforeAGaze: {
        Content: {
          maxEnergyDmgBoost: {
            ...
            content:
              'When the wearer uses Ultimate, increases the wearer\'s Ultimate DMG based on their Max Energy. Each point of Energy increases the Ultimate DMG by {{DmgStep}}%, up to 180 points of Energy.',
          },
        },
      },
      BaptismOfPureThought: {
        Content: {
          debuffCdStacks: {
            ...
            content:
              'For every debuff on the enemy target, the wearer\'s CRIT DMG dealt against this target increases by {{DmgStep}}%, stacking up to 3 times.',
          },
          postUltBuff: {
            text: 'Disputation buffs',
            content:
              'When using Ultimate to attack the enemy target, the wearer receives the Disputation effect, which increases DMG dealt by {{DmgStep}}% and enables their follow-up attacks to ignore {{DefIgnore}}% of the target\'s DEF. This effect lasts for 2 turns.',
          },
        },
      },
      BeforeDawn: {
        Content: {
          fuaDmgBoost: {
            text: 'FUA DMG boost',
            content:
              'After the wearer uses their Skill or Ultimate, they gain Somnus Corpus. Upon triggering a follow-up attack, Somnus Corpus will be consumed and the follow-up attack DMG increases by {{DmgBuff}}%.',
          },
        },
      },
      BrighterThanTheSun: {
        Content: {
          dragonsCallStacks: {
            ...
            content:
              'When the wearer uses their Basic ATK, they will gain 1 stack of Dragon\'s Call, lasting for 2 turns. Each stack of Dragon\'s Call increases the wearer\'s ATK by {{AtkBuff}}% and Energy Regeneration Rate by {{RegenBuff}}%. Dragon\'s Call can be stacked up to 2 times.',
          },
        },
      },
      ...
      DanceAtSunset: {
        Content: {
          fuaDmgStacks: {
            text: 'FUA DMG stacks',
            content:
              'After the wearer uses Ultimate, receives 1 stack of Firedance, lasting for 2 turns and stacking up to 2 times. Each stack of Firedance increases the DMG dealt by the wearer\'s follow-up attack by {{DmgBoost}}%.',
          },
        },
      },
      EarthlyEscapade: {
      ...
      EchoesOfTheCoffin: {
        Content: {
          postUltSpdBuff: {
            ...
            content:
              'After the wearer uses an attack, for each different enemy target the wearer hits, regenerates {{EnergyRecovered}} Energy. Each attack can regenerate Energy up to 3 times this way. After the wearer uses their Ultimate, all allies gain {{SpdBuff}} SPD for 1 turn.',
          },
        },
      },
      EternalCalculus: {
        Content: {
          atkBuffStacks: {
            ...
            content:
              'After using an attack, for each enemy target hit, additionally increases ATK by {{AtkBuff}}%. This effect can stack up to 5 times and last until the next attack.',
          },
          spdBuff: {
      ...
      FlameOfBloodBlazeMyPath: {
        Content: {
          ...
          bonusBoost: {
            ...
            content:
              'When using Skill or Ultimate, consume HP equal to {{HpConsumption}}% of the wearer\'s Max HP. If the consumed HP is greater than 500, this attack\'s DMG additionally increases by {{BonusDmgBoost}}% .',
          },
        },
      },
      FlowingNightglow: {
      ...
      IfTimeWereAFlower: {
        Content: {
          presage: {
            text: 'Presage active',
            content:
              'After the wearer launches a Follow-up ATK, additionally regenerates 12 Energy and gains "Presage," lasting for 2 turns. While the wearer has "Presage," all ally targets\' CRIT DMG increases by {{CdBuff}}%. When entering battle, the wearer regenerates 21 Energy and gains "Presage," lasting for 2 turns.',
          },
        },
      },
      IncessantRain: {
        Content: {
          ...
          targetCodeDebuff: {
            ...
            content:
              'After the wearer uses their Basic ATK, Skill, or Ultimate, there is a 100% base chance to implant Aether Code on a random hit target that does not yet have it. Targets with Aether Code receive {{DmgIncrease}}% increased DMG for 1 turn.',
          },
        },
      },
      InherentlyUnjustDestiny: {
        Content: {
          ...
          targetVulnerability: {
            ...
            content:
              'When the wearer\'s follow-up attack hits an enemy target, there is a {{baseChance}}% base chance to increase the DMG taken by the attacked enemy target by {{Vulnerability}}%, lasting for 2 turns.',
          },
        },
      },
      InTheNameOfTheWorld: {
      ...
      InTheNight: {
        Content: {
          spdScalingBuffs: {
            ...
            content:
              'While the wearer is in battle, for every 10 SPD that exceeds 100, the DMG of the wearer\'s Basic ATK and Skill is increased by {{DmgBuff}}% and the CRIT DMG of their Ultimate is increased by {{CritBuff}}%. This effect can stack up to 6 times.',
          },
        },
      },
      ...
      IShallBeMyOwnSword: {
        Content: {
          eclipseStacks: {
            text: 'Eclipse stacks',
            content:
              'When an ally (excluding the wearer) gets attacked or loses HP, the wearer gains 1 stack of Eclipse, up to a max of 3 stacks. Each stack of Eclipse increases the DMG of the wearer\'s next attack by {{DmgBuff}}%.',
          },
          maxStackDefPen: {
            text: 'Max stack DEF PEN',
            content:
              'When 3 stacks are reached, additionally enables that attack to ignore {{DefIgnore}}% of the enemy\'s DEF. This effect will be removed after the wearer uses an attack.',
          },
        },
      },
      IVentureForthToHunt: {
        Content: {
          luminfluxUltStacks: {
            ...
            content:
              'When the wearer launches a follow-up attack, gains 1 stack of Luminflux, stacking up to 2 times. Each stack of Luminflux enables the Ultimate DMG dealt by the wearer to ignore {{DefIgnore}}% of the target\'s DEF. When the wearer\'s turn ends, removes 1 stack of Luminflux.',
          },
        },
      },
      ...
      LongRoadLeadsHome: {
        Content: {
          breakVulnerabilityStacks: {
            ...
            content:
              'When an enemy target\'s Weakness gets broken, there is a 100% base chance to inflict the "Charring" state on it, which increases its Break DMG taken by {{breakVulnerability}}%, lasting for 2 turns. This effect can stack 2 times.',
          },
        },
      },
      MakeFarewellsMoreBeautiful: {
        Content: {
          deathFlower: {
            ...
            content:
              'When the wearer or their memosprite loses HP during their own turn, the wearer gains "Death Flower," which allows the wearer and their memosprite to ignore {{DefIgnore}}% of the target\'s DEF when dealing DMG, lasting for 2 turns.',
          },
        },
      },
      MayRainbowsRemainInTheSky: {
        Content: {
          vulnerability: {
            text: 'Vulnerability',
            content:
              'When the wearer\'s memosprite uses Memosprite Skill, increases the DMG taken by all enemies by {{Vulnerability}}% for 2 turns. The same types of effects cannot stack.',
          },
        },
      },
      ...
      MomentOfVictory: {
        Content: {
          selfAttackedDefBuff: {
            ...
            content:
              'Increases the chance for the wearer to be attacked by enemies. When the wearer is attacked, increase their DEF by an extra {{DefBuff}}% until the end of the wearer\'s turn.',
          },
        },
      },
      NightOfFright: {
        Content: {
          atkBuffStacks: {
            text: 'ATK buff stacks',
            content:
              'When the wearer provides healing for an ally, increases the healed ally\'s ATK by {{AtkBuff}}%. This effect can stack up to 5 times and lasts for 2 turns.',
          },
        },
      },
      NightOnTheMilkyWay: {
      ...
      ScentAloneStaysTrue: {
        Content: {
          woefreeState: {
            ...
            content:
              'After the wearer uses Ultimate to attack enemy targets, inflicts the targets with the Woefree state, lasting for 2 turns. While in Woefree, enemy targets take {{Vulnerability}}% increased DMG. The effect of increasing DMG taken is additionally boosted by {{AdditionalVulnerability}}% if the wearer\'s current Break Effect is 150% or higher.',
          },
        },
        TeammateContent: {
      ...
      SleepLikeTheDead: {
        Content: {
          missedCritCrBuff: {
            ...
            content:
              'When the wearer\'s Basic ATK or Skill does not result in a CRIT Hit, increases their CRIT Rate by {{CritBuff}}% for 1 turn. This effect can only trigger once every 3 turns.',
          },
        },
      },
      SolitaryHealing: {
      ...
      SomethingIrreplaceable: {
        Content: {
          dmgBuff: {
            ...
            content:
              'When the wearer defeats an enemy or is hit, immediately restores HP equal to {{Multiplier}}% of the wearer\'s ATK. At the same time, the wearer\'s DMG is increased by {{DmgBuff}}% until the end of their next turn. This effect cannot stack and can only trigger 1 time per turn.',
          },
        },
      },
      TextureOfMemories: {
        Content: {
          activeShieldDmgDecrease: {
            ...
            content:
              'If the wearer is attacked and has no Shield, they gain a Shield equal to {{ShieldHp}}% of their Max HP for 2 turns. This effect can only be triggered once every 3 turns. If the wearer has a Shield when attacked, the DMG they receive decreases by {{DmgReduction}}%.',
          },
        },
      },
      TheUnreachableSide: {
        Content: {
          dmgBuff: {
            ...
            content:
              'When the wearer is attacked or consumes their own HP, their DMG increases by {{DmgBuff}}%. This effect is removed after the wearer uses an attack.',
          },
        },
      },
      ThoseManySprings: {
      ...
      WhereaboutsShouldDreamsRest: {
        Content: {
          routedVulnerability: {
            ...
            content:
              'When the wearer deals Break DMG to an enemy target, inflicts Routed on the enemy, lasting for 2 turns. Targets afflicted with Routed receive {{Vulnerability}}% increased Break DMG from the wearer, and their SPD is lowered by 20%. Effects of the similar type cannot be stacked.',
          },
        },
      },
      WorrisomeBlissful: {
        Content: {
          targetTameStacks: {
            ...
            content:
              'After the wearer uses a follow-up attack, apply the Tame state to the target, stacking up to 2 stacks. When allies hit enemy targets under the Tame state, every Tame stack increases the CRIT DMG dealt by {{CritBuff}}%.',
          },
        },
      },
      YetHopeIsPriceless: {
        Content: {
          fuaDmgBoost: {
            ...
            content:
              'While the wearer is in battle, for every 20% CRIT DMG that exceeds 120%, the DMG dealt by follow-up attack increases by {{DmgBuff}}%. This effect can stack up to 4 times.',
          },
          ultFuaDefShred: {
            text: 'Ult / FUA DEF PEN',
            content:
              'When the battle starts or after the wearer uses their Basic ATK, enables Ultimate or the DMG dealt by follow-up attack to ignore {{DefShred}}% of the target\'s DEF, lasting for 2 turns.',
          },
        },
      },
      ...
      ASecretVow: {
        Content: {
          enemyHpHigherDmgBoost: {
            ...
            content:
              'The wearer also deals an extra {{DmgBuff}}% of DMG to enemies whose current HP percentage is equal to or higher than the wearer\'s current HP percentage.',
          },
        },
      },
      BoundlessChoreo: {
      ...
      DreamvilleAdventure: {
        Content: {
          ultDmgBuff: {
            text: 'Ult DMG boost',
            content:
              'After the wearer uses a certain type of ability such as Basic ATK, Skill, or Ultimate, all allies gain Childishness, which increases allies\' DMG for the same type of ability as used by the wearer by {{DmgBuff}}%. Childishness only takes effect for the most recent type of ability the wearer used and cannot be stacked.',
          },
          skillDmgBuff: {
      ...
      FinalVictor: {
        Content: {
          goodFortuneStacks: {
            ...
            content:
              'When the wearer lands a CRIT hit on enemies, gains a stack of Good Fortune, stacking up to 4 times. Every stack of Good Fortune the wearer has will increase their CRIT DMG by {{CritBuff}}%. Good Fortune will be removed at the end of the wearer\'s turn.',
          },
        },
      },
      FlamesAfar: {
        Content: {
          dmgBuff: {
            text: 'DMG buff',
            content:
              'When the cumulative HP loss of the wearer during a single attack exceeds 25% of their Max HP, or if the amount of their own HP they consume at one time is greater than 25% of their Max HP, immediately heals the wearer for 15% of their Max HP, and at the same time, increases the DMG they deal by {{DmgBuff}}% for 2 turns. This effect can only be triggered once every 3 turns.',
          },
        },
      },
      ForTomorrowsJourney: {
      ...
      GoodNightAndSleepWell: {
        Content: {
          debuffStacksDmgIncrease: {
            ...
            content:
              'For every debuff the target enemy has, the DMG dealt by the wearer increases by {{DmgBuff}}%, stacking up to 3 times. This effect also applies to DoT.',
          },
        },
      },
      HeyOverHere: {
      ...
      ItsShowtime: {
        Content: {
          trickStacks: {
            text: 'Trick stacks',
            content:
              'When the wearer inflicts a debuff on an enemy, gains a stack of Trick. Every stack of Trick increases the wearer\'s DMG dealt by {{DmgBuff}}%, stacking up to 3 times. This effect lasts for 1 turn. When the wearer\'s Effect Hit Rate is 80% or higher, increases ATK by {{AtkBuff}}%.',
          },
        },
      },
      MakeTheWorldClamor: {
      ...
      PerfectTiming: {
        Content: {
          resToHealingBoost: {
            ...
            content:
              'Increases the wearer\'s Outgoing Healing by an amount that is equal to {{Scaling}}% of Effect RES. Outgoing Healing can be increased this way by up to {{Limit}}%.',
          },
        },
      },
      PlanetaryRendezvous: {
      ...
      ResolutionShinesAsPearlsOfSweat: {
        Content: {
          targetEnsnared: {
            ...
            content:
              'When the wearer hits an enemy and if the hit enemy is not already Ensnared, then there is a {{BaseChance}}% base chance to Ensnare the hit enemy. Ensnared enemies\' DEF decreases by {{DefShred}}% for 1 turn.',
          },
        },
      },
      RiverFlowsInSpring: {
        Content: {
          spdDmgBuff: {
            ...
            content:
              'After entering battle, increases the wearer\'s SPD by {{SpdBuff}}% and DMG by {{DmgBuff}}%. When the wearer takes DMG, this effect will disappear. This effect will resume after the end of the wearer\'s next turn.',
          },
        },
      },
      ShadowedByNight: {
      ...
      SubscribeForMore: {
        Content: {
          maxEnergyDmgBoost: {
            text: 'Max energy DMG boost',
            content:
              'Increases the DMG of the wearer\'s Basic ATK and Skill by {{DmgBuff}}%. This effect increases by an extra {{DmgBuff}}% when the wearer\'s current Energy reaches its max level.',
          },
        },
      },
      SweatNowCryLess: {
      ...
      Swordplay: {
        Content: {
          sameTargetHitStacks: {
            ...
            content:
              'For each time the wearer hits the same target, DMG dealt increases by {{DmgBuff}}%, stacking up to 5 times. This effect will be dispelled when the wearer changes targets.',
          },
        },
      },
      TheBirthOfTheSelf: {
      ...
      TheDayTheCosmosFell: {
        Content: {
          cdBuffActive: {
            ...
            content:
              'When the wearer uses an attack and at least 2 attacked enemies have the corresponding Weakness, the wearer\'s CRIT DMG increases by {{CritBuff}}% for 2 turns.',
          },
        },
      },
      TheGreatCosmicEnterprise: {
        Content: {
          weaknessTypes: {
            text: 'Weakness types',
            content:
              'For every different Weakness Type an enemy target has, increases the DMG dealt by the wearer by {{DmgBuff}}%, up to a max of 7 Weakness Types.',
          },
        },
      },
      TheMolesWelcomeYou: {
        Content: {
          atkBuffStacks: {
            text: 'ATK buff stacks',
            content:
              'When the wearer uses Basic ATK, Skill, or Ultimate to attack enemies, the wearer gains one stack of Mischievous. Each stack increases the wearer\'s ATK by {{AtkBuff}}%.',
          },
        },
      },
      ...
      ThisIsMe: {
        Content: {
          defScalingUltDmg: {
            ...
            content:
              'Increases the DMG of the wearer when they use their Ultimate by {{Multiplier}}% of the wearer\'s DEF. This effect only applies 1 time per enemy target during each use of the wearer\'s Ultimate.',
          },
        },
      },
      TodayIsAnotherPeacefulDay: {
        Content: {
          maxEnergyDmgBoost: {
            text: 'Max energy',
            content:
              'After entering battle, increases the wearer\'s DMG based on their Max Energy. DMG increases by {{DmgStep}}% per point of Energy, up to 160 Energy.',
          },
        },
      },
      UnderTheBlueSky: {
      ...
      VictoryInABlink: {
        Content: {
          teamDmgBuff: {
            text: 'Team DMG buff',
            content:
              'When the wearer\'s memosprite uses an ability on any ally target, increases all ally targets\' DMG dealt by {{DmgBuff}}%, lasting for 3 turns.',
          },
        },
      },
      WeAreWildfire: {
        Content: {
          initialDmgReductionBuff: {
            ...
            content:
              'At the start of the battle, the DMG dealt to all allies decreases by {{DmgReduction}}% for 5 turns. At the same time, immediately restores HP to all allies equal to {{Healing}}% of the respective HP difference between the characters\' Max HP and current HP.',
          },
        },
      },
      WeWillMeetAgain: {
        Content: {
          extraDmgProc: {
            ...
            content:
              'After the wearer uses Basic ATK or Skill, deals Additional DMG equal to {{Multiplier}}% of the wearer\'s ATK to a random enemy that has been attacked.',
          },
        },
      },
      WoofWalkTime: {
      ...
      Reminiscence: {
        Content: {
          dmgStacks: {
            text: 'DMG stacks',
            content:
              'When memosprite\'s turn starts, the wearer and the memosprite each gain 1 stack of "Commemoration." Each stack increases DMG dealt by {{DmgBuff}}%, stacking up to 4 times. "Commemoration" is removed from the wearer and the memosprite when the memosprite disappears.',
          },
        },
      },
      Sagacity: {
      ...
      Aglaea: {
        Content: {
          supremeStanceState: {
            ...
            content:
              'While in the "Supreme Stance" state, Aglaea gains the SPD Boost stacks from Garmentmaker\'s Memosprite Talent, with each stack increasing her SPD by {{SpdBuff}}%. Enhances Basic ATK to "Slash by a Thousandfold Kiss," and cannot use Skill.',
          },
          seamStitch: {
            text: 'Seam Stitch',
            content:
              'While Garmentmaker is on the field, Aglaea\'s attacks inflict the target with the "Seam Stitch" state. After attacking enemies in the "Seam Stitch" state, further deals Lightning Additional DMG equal to {{Scaling}}% of Aglaea\'s ATK. "Seam Stitch" only takes effect on the most recently inflicted target.',
          },
          memoSpdStacks: {
          ...
          e2DefShredStacks: {
            ...
            content:
              'When Aglaea or Garmentmaker takes action, the DMG dealt by Aglaea and Garmentmaker ignores 14% of the target\'s DEF. This effect stacks up to 3 times and lasts until any unit, other than Aglaea or Garmentmaker, actively uses an ability.',
          },
          e6Buffs: {
            text: 'E6 buffs',
            content:
      ...
      Anaxa: {
        Content: {
          ...
          exposedNature: {
            ...
            content:
              'While Anaxa is on the battlefield, inflicts the "Qualitative Disclosure" state to enemy targets with at least 5 different Weaknesses. Anaxa deals {{DmgBuff}}% more DMG to targets in "Qualitative Disclosure" state.',
          },
          eruditionTeammateBuffs: {
            text: 'Erudition teammate buffs',
            content:
              'Trigger any 1 effect in the current battle based on the number of characters on the Path of Erudition in the team: ::BR:: 1: Increases Anaxa\'s CRIT DMG by 140%. ::BR:: At least 2: Increases DMG dealt by all allies by 50%.',
          },
          enemyWeaknessTypes: {
            text: 'Enemy weaknesses',
            content:
              'For every different Weakness Type an enemy target has, the DMG that Anaxa deals to that target ignores 4% of DEF, up to a max of 7 Weakness Types.',
          },
          e1DefPen: {
            text: 'E1 DEF PEN',
          ...
          e6Buffs: {
            text: 'E6 buffs',
            content:
              'The DMG dealt by Anaxa is 130% of the original DMG. The 2 effects of the Trace "Imperative Hiatus" will be triggered directly and will no longer depend on the number of Erudition characters on the team.',
          },
        },
      },
      Argenti: {
        Content: {
          ultEnhanced: {
            text: 'Enhanced Ult',
            content:
              'Consumes 180 Energy and deals Physical DMG equal to {{ultEnhancedScaling}}% of Argenti\'s ATK to all enemies, and further deals DMG for 6 extra times, with each time dealing Physical DMG equal to {{ultEnhancedExtraHitScaling}}% of Argenti\'s ATK to a random enemy.',
          },
          enemyHp50: {
      ...
      Arlan: {
        Content: {
          selfCurrentHpPercent: {
            ...
            content:
              'Based on Arlan\'s current missing HP percentage, gains DMG bonus, up to a maximum increase of {{talentMissingHpDmgBoostMax}}% DMG dealt by Arlan.',
          },
        },
      },
      Asta: {
        Content: {
          skillExtraDmgHits: {
            ...
            content:
              'Deals Fire DMG equal to {{skillScaling}}% of Asta\'s ATK to a single enemy and further deals DMG for {{skillExtraDmgHitsMax}} extra times, with each time dealing Fire DMG equal to {{skillScaling}}% of Asta\'s ATK to a random enemy.::BR::E1: When using Skill, deals DMG for 1 extra time to a random enemy.',
          },
          talentBuffStacks: {
            text: 'Talent ATK buff stacks',
            content:
              'Increases allies\' ATK by {{talentStacksAtkBuff}}% for every stack.::BR::E4: Asta\'s Energy Regeneration Rate increases by 15% when she has 2 or more Charging stacks.',
          },
          ultSpdBuff: {
      ...
      Blade: {
        Content: {
          enhancedStateActive: {
            ...
            content:
              'Increases DMG by {{enhancedStateDmgBoost}}% and his Basic ATK Shard Sword is enhanced to Forest of Swords for 3 turns.::BR::E2: Increases CRIT Rate by 15%.',
          },
          hpPercentLostTotal: {
            text: 'HP% lost total',
            content:
              'Ultimate DMG scales off of the tally of Blade\'s HP loss in the current battle. The tally of Blade\'s HP loss in the current battle is capped at {{hpPercentLostTotalMax}}% of his Max HP.',
          },
      ...
      Boothill: {
        Content: {
          ...
          e2BeBuff: {
            text: 'E2 BE buff',
            content:
              'When in Standoff and gaining Pocket Trickshot, recovers 1 Skill Point and increases Break Effect by 30%, lasting for 2 turns. Can also trigger this effect when gaining Pocket Trickshot stacks that exceed the max limit. But cannot trigger repeatedly within one turn.',
          },
      ...
      Bronya: {
        Content: {
          ...
          skillBuff: {
            text: 'Skill DMG buff',
            content:
              'Dispels a debuff from a single ally, allows them to immediately take action, and increases their DMG by {{skillDmgBoostValue}}% for 1 turn.',
          },
          ultBuff: {
            text: 'Ult ATK / CD buffs',
            content:
              'Increases the ATK of all allies by {{ultAtkBoostValue}}% and CRIT DMG by {{ultCdBoostValue}}% of Bronya\'s CRIT DMG plus {{ultCdBoostBaseValue}}% for 2 turns.',
          },
          battleStartDefBuff: {
      ...
      Castorice: {
        Content: {
          ...
          talentDmgStacks: {
            ...
            content:
              'When allies lose HP, Castorice\'s and Netherwing\'s DMG dealt increase by {{DmgBuff}}%. This effect can stack up to 3 times, lasting for 3 turns.',
          },
          memoSkillEnhances: {
            text: 'Memo Skill enhances',
            content:
              'In one attack, "Breath Scorches the Shadow" can be activated repeatedly, with the DMG multiplier increasing respectively to {{Multiplier1Enhance}}% / {{Multiplier2Enhance}}%, until {{Multiplier2Enhance}}%. The DMG Multiplier Boost effect will not be reduced before Netherwing disappears.',
          },
          memoTalentHits: {
            text: 'Memo Talent hits',
            content:
              'When Netherwing disappears, deals {{BounceCount}} instances of DMG, with every instance dealing Quantum DMG equal to {{Scaling}}% of Castorice\'s Max HP to one random enemy units.',
          },
          teamDmgBoost: {
            text: 'Team DMG boost',
          ...
          e1EnemyHp50: {
            text: 'E1 Enemy HP ≤ 50%',
            content:
              'When the enemy target\'s current HP is 50% or lower than this unit\'s Max HP, the DMG dealt with "Boneclaw, Doomdrake\'s Embrace," "Claw Splits the Veil," "Breath Scorches the Shadow," and "Wings Sweep the Ruins" is 140% of the original DMG.',
          },
          e6Buffs: {
            text: 'E6 buffs',
            content:
              'When Castorice or Netherwing deals DMG, increases Quantum RES PEN by 20%. ::BR:: Increases the Bounce count for Netherwing\'s Talent "Wings Sweep the Ruins" by 3 times.',
          },
        },
      },
      Cipher: {
        Content: {
          ...
          skillAtkBuff: {
            text: 'Skill ATK buff',
            content:
              'When using skill, there is a 120% base chance to Weaken one designated enemy and adjacent targets, decreasing their DMG dealt by 10% and increasing Cipher\'s ATK by 30%, lasting for 2 turns.',
          },
          fuaCdBoost: {
            text: 'FUA CD boost',
      ...
      Clara: {
        Content: {
          ultBuff: {
            text: 'Ult buffs',
            content:
              'Increases Svarog Counter DMG by {{ultFuaExtraScaling}}% during Ultimate. DMG dealt to Clara is reduced by an extra {{ultDmgReductionValue}}% for 2 turns.',
          },
          talentEnemyMarked: {
            text: 'Enemy Marked',
      ...
      Feixiao: {
        Content: {
          ...
          talentDmgBuff: {
            ...
            content:
              'After Feixiao\'s teammates attack enemy targets, Feixiao immediately launches follow-up attack against the primary target, dealing Wind DMG equal to {{FuaMultiplier}}% of Feixiao\'s ATK. If there is no primary target available to attack, Feixiao attacks a single random enemy instead. This effect can only trigger once per turn and the trigger count resets at the start of Feixiao\'s turn. When using this attack, increases DMG dealt by this unit by {{DmgBuff}}%, lasting for 2 turns.',
          },
          skillAtkBuff: {
            text: 'Skill ATK buff',
          ...
          e1OriginalDmgBoost: {
            ...
            content:
              'After launching Boltsunder Blitz or Waraxe Skyward, additionally increases the Ultimate DMG dealt by Feixiao by an amount equal to 10% of the original DMG, stacking up to 5 times and lasting until the end of the Ultimate action.',
          },
          e4Buffs: {
            text: 'E4 buffs',
            content:
              'The Toughness Reduction from the Talent\'s Follow-up ATK increases by 100% and, when launched, increases this unit\'s SPD by 8%, lasting for 2 turns.',
          },
          e6Buffs: {
            text: 'E6 buffs',
            content:
      ...
      Firefly: {
        Content: {
          ...
          talentDmgReductionBuff: {
            text: 'Max EHP buff',
            content:
              'The lower the HP, the less DMG received. When HP is 20% or lower, the DMG Reduction reaches its maximum effect, reducing up to {{talentDmgReductionBuff}}%. During the Complete Combustion, the DMG Reduction remains at its maximum effect, and the Effect RES increases by {{talentResBuff}}%.',
          },
          e1DefShred: {
            text: 'E1 DEF PEN',
      ...
      Fugue: {
        Content: {
          ...
          defReduction: {
            ...
            content:
              'When an ally target with "Foxian Prayer" attacks, Fugue has a 100% base chance to reduce the attacked enemy target\'s DEF by {{DefShred}}%, lasting for 2 turns.',
          },
          superBreakDmg: {
            text: 'Super Break DMG (force weakness break)',
            content:
              'While Fugue is on the field and after allies attack Weakness Broken enemy targets, converts the Toughness Reduction of this attack into 1 instance of {{SuperBreakMultiplier}}% Super Break DMG.',
          },
          e4BreakDmg: {
          ...
          e6BreakEfficiency: {
            ...
            content:
              'Increases Fugue\'s Weakness Break Efficiency by 50%. When Fugue is in the "Torrid Scorch" state, "Foxian Prayer" will take effect on all allies.',
          },
        },
        TeammateContent: {
          be220Buff: {
            text: 'BE ≥ 220%',
            content:
              'When an enemy target\'s Weakness gets broken, Break Effect of teammates increases by 6%. If Fugue\'s Break Effect is 220% or more, the Break Effect Boost effect additionally increases by 12%, lasting for 2 turns. This effect can stack up to 2 times.',
          },
      ...
      FuXuan: {
        Content: {
          talentActive: {
            ...
            content:
              'While Fu Xuan is still active in battle, Misfortune Avoidance is applied to the entire team. With Misfortune Avoidance, allies take {{talentDmgReductionValue}}% less DMG.',
          },
          skillActive: {
            text: 'Skill active',
            content:
          ...
          e6TeamHpLostPercent: {
            ...
            content:
              'Once Matrix of Prescience is activated, it will keep a tally of the total HP lost by all team members in the current battle. Fu Xuan\'s Ultimate DMG will increase by 200% of this tally of HP loss. This tally is also capped at 120% of Fu Xuan\'s Max HP.',
          },
        },
        TeammateContent: {
          teammateHPValue: {
            ...
            content:
              'While affected by Matrix of Prescience, all team members gain the Knowledge effect, which increases their respective Max HP by {{skillHpBuffValue}}% of Fu Xuan\'s Max HP.',
          },
        },
      },
      Gallagher: {
      ...
      Guinaifen: {
        Content: {
          talentDebuffStacks: {
            ...
            content:
              'While inflicted with Firekiss, the enemy receives {{talentDebuffDmgIncreaseValue}}% increased DMG, which lasts for 3 turns and can stack up to {{talentDebuffMax}} times.',
          },
          enemyBurned: {
            text: 'Enemy burned',
      ...
      Hanya: {
        Content: {
          ultBuff: {
            ...
            content:
              'Increases the SPD of a target ally by {{ultSpdBuffValue}}% of Hanya\'s SPD and increases the same target ally\'s ATK by {{ultAtkBuffValue}}%.',
          },
          targetBurdenActive: {
            text: 'Target Burden debuff',
            content:
              'When an ally uses a Basic ATK, Skill, or Ultimate on an enemy inflicted with Burden, the DMG dealt increases by {{talentDmgBoostValue}}% for 2 turns.',
          },
          burdenAtkBuff: {
      ...
      Hook: {
        Content: {
          enhancedSkill: {
            text: 'Enhanced Skill',
            content:
              'After using Ultimate, the next Skill to be used is Enhanced. Enhanced Skill deals Fire DMG equal to {{skillEnhancedScaling}}% of Hook\'s ATK to a single enemy and reduced DMG to adjacent enemies.',
          },
          targetBurned: {
            text: 'Target burned',
            content:
              'When attacking a target afflicted with Burn, deals Additional Fire DMG equal to {{targetBurnedExtraScaling}}% of Hook\'s ATK.::BR::E6: Hook deals 20% more DMG to enemies afflicted with Burn.',
          },
        },
      },
      Huohuo: {
      ...
      Hyacine: {
        Content: {
          healTargetHp50: {
            ...
            content:
              'When providing healing to an ally target with less than or equal to 50% this unit\'s Max HP, increases Hyacine and Little Ica\'s Outgoing Healing by 25%.',
          },
          resBuff: {
          ...
          clearSkies: {
            ...
            content:
              'After using her ultimate, Hyacine enters the "After Rain" state for 3 turns. Reduces the state\'s duration by 1 turn each time Hyacine\'s turn begins. When in "After Rain" state, increases Max HP for all allies by {{UltHpBuffScaling}}% plus {{UltHpBuffFlat}}.',
          },
          healingDmgStacks: {
      ...
      ImbibitorLunae: {
        Content: {
          basicEnhanced: {
            ...
            content:
              '0 stacks: Uses a 2-hit attack and deals Imaginary DMG equal to {{basicScaling}}% ATK to a single enemy target.::BR::1 stack: Uses a 3-hit attack and deals Imaginary DMG equal to {{basicEnhanced1Scaling}}% ATK to a single enemy target.::BR::2 stacks: Uses a 5-hit attack and deals Imaginary DMG equal to {{basicEnhanced2Scaling}}% ATK to a single enemy target and reduced DMG to adjacent targets.::BR::3 stacks: Uses a 7-hit attack and deals Imaginary DMG equal to {{basicEnhanced3Scaling}}% ATK to a single enemy target and reduced DMG to adjacent targets.',
          },
          skillOutroarStacks: {
            text: 'Outroar stacks',
            content:
              'Divine Spear or Fulgurant Leap, starting from the fourth hit, 1 stack of Outroar is gained before every hit. Each stack of Outroar increases Dan Heng • Imbibitor Lunae\'s CRIT DMG by {{outroarStackCdValue}}%, for a max of 4 stacks. (applied to all hits)',
          },
          talentRighteousHeartStacks: {
            text: 'Righteous Heart stacks',
            content:
              'After each hit dealt during an attack, Dan Heng • Imbibitor Lunae gains 1 stack of Righteous Heart, increasing his DMG by {{righteousHeartDmgValue}}%. (applied to all hits)',
          },
          e6ResPenStacks: {
      ...
      Jade: {
        Content: {
          ...
          e1FuaDmgBoost: {
            ...
            content:
              'The follow-up attack DMG from Jade\'s Talent increases by 32%. After the Debt Collector character attacks and the number of the enemy targets hit is either 2 or 1, Jade additionally gains 1 or 2 points of Charge respectively.',
          },
          e2CrBuff: {
            text: 'E2 CR buff',
      ...
      Jingliu: {
        Content: {
          talentEnhancedState: {
            text: 'Enhanced state',
            content:
              'When Jingliu has 2 stacks of Syzygy, she enters the Spectral Transmigration state with her Action Advanced by 100% and her CRIT Rate increases by {{talentCrBuff}}%. Then, Jingliu\'s Skill Transcendent Flash becomes enhanced and turns into Moon On Glacial River, and becomes the only ability she can use in battle.',
          },
          ...
          e1CdBuff: {
            text: 'E1 Ult active',
            content:
              'When using her Ultimate or Enhanced Skill, Jingliu\'s CRIT DMG increases by 24% for 1 turn. If only one enemy target is attacked, the target will additionally be dealt Ice DMG equal to 100% of Jingliu\'s ATK.',
          },
          e2SkillDmgBuff: {
            text: 'E2 Skill buff',
      ...
      JingYuan: {
        Content: {
          ...
          e6FuaVulnerabilityStacks: {
            ...
            content:
              'Each hit performed by the Lightning-Lord when it takes action will make the target enemy Vulnerable. While Vulnerable, enemies receive 12% more DMG until the end of the Lightning-Lord\'s current turn, stacking up to 3 times. (applies to all hits)',
          },
        },
      },
      Kafka: {
      ...
      March7thImaginary: {
        Content: {
          enhancedBasic: {
            text: 'Enhanced Basic',
            content:
              'Initially, deals 3 hits, each causing Imaginary DMG equal to {{BasicEnhancedScaling}}% of March 7th\'s ATK to a single target enemy. Whenever dealing the final hit, there is a 60% fixed chance to deal 1 additional hit of DMG, up to a max of 3 additional hits.',
          },
          basicAttackHits: {
          ...
          masterAdditionalDmgBuff: {
            text: 'DPS Shifu buff',
            content:
              'Whenever using Basic ATK or dealing 1 hit of Enhanced Basic ATK\'s DMG, deals Additional DMG equal to {{ShifuDmgBuff}}% of March 7th\'s ATK.',
          },
          masterToughnessRedBuff: {
            text: 'Support Shifu buff',
            content:
              'Whenever using Basic ATK or dealing 1 hit of Enhanced Basic ATK\'s DMG, increases the Toughness Reduction of this instance of DMG by 100%.',
          },
          talentDmgBuff: {
      ...
      Mydei: {
        Content: {
          ...
          e1EnhancedSkillBuff: {
            ...
            content:
              'The DMG multiplier dealt by "Godslayer Be God" to the primary target increases by 30%. And "Godslayer Be God" becomes Imaginary DMG dealt to all enemies equal to the DMG multiplier applied to the primary target.',
          },
          e2DefPen: {
            text: 'E2 DEF PEN',
            content:
              'During "Vendetta," the DMG dealt by Mydei ignores 15% of enemy targets\' DEF. And when receiving healing, converts 40% of the healed amount to Charge. The tally of the converted Charge cannot exceed 40 points. Resets this tally of Charge after any unit takes action.',
          },
          e4CdBuff: {
            text: 'E4 CD buff',
      ...
      Pela: {
        Content: {
          ...
          skillRemovedBuff: {
            ...
            content:
              'Using Skill to remove buffs increases the DMG of Pela\'s next attack by 20%.::BR::E2: Using Skill to remove buffs increases SPD by 10% for 2 turns.',
          },
          ultDefPenDebuff: {
            text: 'Ult DEF shred',
      ...
      Qingque: {
        Content: {
          ...
          skillDmgIncreaseStacks: {
            ...
            content:
              'Immediately draws 2 jade tiles and increases DMG by {{skillStackDmg}}% until the end of the current turn. This effect can stack up to 4 times.',
          },
        },
      },
      Rappa: {
        Content: {
          sealformActive: {
            ...
            content:
              'Enters the "Sealform" state, immediately gains 1 extra turn, obtains 3 points of "Chroma Ink," and increases Weakness Break Efficiency by 50% and Break Effect by {{ultBeBuff}}%.',
          },
          atkToBreakVulnerability: {
            text: 'ATK to Break vulnerability',
            content:
              'When an enemy target becomes Weakness Broken, increases the Break DMG taken by 2%. If Rappa\'s current ATK is higher than 2400, for every 100 excess ATK, additionally increases this value by 1%, up to a max additional increase of 8%.',
          },
          chargeStacks: {
            text: 'Charge stacks',
            content:
              'Each point of Charge increases the Break DMG multiplier by {{talentChargeMultiplier}}% and increases the Toughness Reduction that can ignore Weakness Type by 1.',
          },
          e1DefPen: {
            text: 'E1 DEF PEN',
      ...
      Robin: {
        Content: {
          ...
          e6UltCDBoost: {
            ...
            content:
              'While the Concerto state is active, the CRIT DMG for the Additional Physical DMG caused by the Ultimate increases by 450%. The effect of Moonless Midnight can trigger up to 8 times. And the trigger count resets each time the Ultimate is used.',
          },
        },
        TeammateContent: {
          teammateATKValue: {
            ...
            content:
              'While in the Concerto state, increases all allies\' ATK by {{ultAtkBuffScalingValue}}% of Robin\'s ATK plus {{ultAtkBuffFlatValue}}.::BR::Set this to the Robin\'s self ATK stat that she uses to buff teammates.',
          },
          traceFuaCdBoost: {
            text: 'FUA CD boost',
      ...
      RuanMei: {
        Content: {
          skillOvertoneBuff: {
            text: 'Overtone buff',
            content:
              'After using her Skill, Ruan Mei gains Overtone, lasting for 3 turns. This duration decreases by 1 at the start of Ruan Mei\'s turn. When Ruan Mei has Overtone, all allies\' DMG increases by {{skillScaling}}% and Weakness Break Efficiency increases by 50%.',
          },
          teamBEBuff: {
            text: 'Team BE buff',
      ...
      Seele: {
        Content: {
          buffedState: {
            text: 'Buffed state',
            content:
              'Enters the buffed state upon defeating an enemy with Basic ATK, Skill, or Ultimate, and receives an extra turn. While in the buffed state, the DMG of Seele\'s attacks increases by {{buffedStateDmgBuff}}% for 1 turn.::BR::While Seele is in the buffed state, her Quantum RES PEN increases by 20%.',
          },
          speedBoostStacks: {
            text: 'Speed buff stacks',
            content:
              'After using her skill, Seele\'s SPD increases by 25% for 2 turns.::BR::E2: The SPD Boost effect of Seele\'s Skill can stack up to 2 times.',
          },
          e1EnemyHp80CrBoost: {
          ...
          e6UltTargetDebuff: {
            ...
            content:
              'After Seele uses her Ultimate, inflict the target enemy with Butterfly Flurry for 1 turn. Enemies suffering from Butterfly Flurry will take Additional Quantum DMG equal to 15% of Seele\'s Ultimate DMG every time they are attacked.',
          },
        },
      },
      Serval: {
      ...
      Sunday: {
        Content: {
          skillDmgBuff: {
            text: 'Skill DMG buff',
            content:
              'Enables one designated ally character and their summon to immediately take action, and increases their DMG dealt by {{DmgBoost}}%. If the target has a summon, then additionally increases the DMG boost effect by {{SummonDmgBoost}}%.',
          },
          talentCrBuffStacks: {
          ...
          e1DefPen: {
            text: 'E1 DEF PEN',
            content:
              'When Sunday uses his Skill, allows target character to ignore 16% of enemy target\'s DEF and their summons to ignore 40% of enemy target\'s DEF when dealing DMG, lasting for 2 turns.',
          },
          e2DmgBuff: {
        ...
        TeammateContent: {
          beatified: {
            text: 'Ult CD buff',
            content:
              'The target and their summon have their CRIT DMG increased by an amount equal to {{CritBuffScaling}}% of Sunday\'s CRIT DMG plus {{CritBuffFlat}}%.',
          },
          teammateCDValue: {
          ...
          e6CrToCdConversion: {
            ...
            content:
              'When the Talent\'s CRIT Rate boost takes effect and the target\'s CRIT Rate exceeds 100%, every 1% of excess CRIT Rate increases CRIT DMG by 2%.',
          },
        },
      },
      Sushang: {
        Content: {
          ultBuffedState: {
            ...
            content:
              'Sushang\'s ATK increases by {{ultBuffedAtk}}% and using her Skill has 2 extra chances to trigger Sword Stance for 2 turns. Sword Stance triggered from the extra chances deals 50% of the original DMG.',
          },
          skillExtraHits: {
            text: 'Skill extra hits',
      ...
      TheHerta: {
        Content: {
          enhancedSkill: {
            text: 'Enhanced Skill',
            content:
              'After using the Ultimate, The Herta immediately takes action and gains 1 stack of "Inspiration." "Inspiration" can stack up to 4 times. While having "Inspiration," enhances Skill to "Hear Me Out."',
          },
          eruditionTeammate: {
          ...
          totalInterpretationStacks: {
            text: 'Answer stacks',
            content:
              'For every 1 stack of "Interpretation" inflicted on enemy targets, The Herta gains 1 stack of "Answer", up to 99 stacks. When using the Ultimate, every stack of "Answer" increases the Ultimate\'s DMG multiplier by 1%.',
          },
          e1BonusStacks: {
            text: 'E1 Bonus stacks',
            content:
              'When Enhanced Skill calculates "Interpretation," additionally calculates 50% of the "Interpretation" stacks on the 1 target with the highest stacks out of the primary target and adjacent targets.',
          },
          e4EruditionSpdBuff: {
      ...
      Tingyun: {
        Content: {
          benedictionBuff: {
            ...
            content:
              'Grants a single ally with Benediction to increase their ATK by {{skillAtkBoostScaling}}%, up to {{skillAtkBoostMax}}% of Tingyun\'s current ATK. When the ally with Benediction attacks, it deals lightning damage equal to {{skillLightningDmgBoostScaling}}% of that ally\'s ATK. This effect lasts for 3 turns.',
          },
          skillSpdBuff: {
            text: 'Skill SPD buff',
          ...
          ultDmgBuff: {
            text: 'Ult DMG buff',
            content:
              'Regenerates 50 Energy for a single ally and increases the target\'s DMG by {{ultDmgBoost}}% for 2 turns.::BR::E6: Ultimate regenerates 10 more Energy for the target ally.',
          },
          ultSpdBuff: {
      ...
      Topaz: {
        Content: {
          enemyProofOfDebtDebuff: {
            ...
            content:
              'Inflicts a single target enemy with a Proof of Debt status, increasing the DMG it takes from follow-up attacks by {{proofOfDebtFuaVulnerability}}%.',
          },
          numbyEnhancedState: {
            text: 'Numby enhanced state',
            content:
              'Numby enters the Windfall Bonanza! state and its DMG multiplier increases by {{enhancedStateFuaScalingBoost}}% and CRIT DMG increases by {{enhancedStateFuaCdBoost}}%.',
          },
          e1DebtorStacks: {
      ...
      TrailblazerPreservation: {
        Content: {
          enhancedBasic: {
            text: 'Enhanced Basic',
            content:
              'Enhanced basic ATK deals Fire DMG equal to {{basicEnhancedAtkScaling}}% of the Trailblazer\'s ATK to a single enemy, and reduced damage to adjacent enemies.',
          },
          skillActive: {
      ...
      TrailblazerRemembrance: {
        Content: {
          memoSkillHits: {
            ...
            content:
              'Deals 4 instances of DMG, with each instance dealing Ice DMG equal to {{SingleScaling}}% of Mem\'s ATK to one random enemy. Finally, deals Ice DMG equal to {{AoeScaling}}% of Mem\'s ATK to all enemies.',
          },
          teamCdBuff: {
            text: 'Team CD buff',
      ...
      Tribbie: {
        Content: {
          numinosity: {
            text: 'Numinosity',
            content:
              'After using Skill, Tribbie gains "Numinosity," lasting for 3 turns. This duration decreases by 1 at the start of this unit\'s every turn. While Tribbie has "Numinosity," increases all ally targets\' All-Type RES PEN by {{ResPen}}%.',
          },
          ultZone: {
            text: 'Ult Zone active',
            content:
              'After Tribbie uses her Ultimate, activates a Zone and deals Quantum DMG equal to {{UltScaling}}% of her Max HP to all enemies. While the Zone lasts, increases enemy targets\' DMG taken by {{ZoneVulnerability}}%. After an ally target attacks, for every 1 target hit, deals 1 instance of Quantum Additional DMG equal to {{AdditionalDmgScaling}}% of Tribbie\'s Max HP to the target that has the highest HP among the hit targets. The Zone lasts for 2 turns. This duration decreases by 1 at the start of this unit\'s every turn.',
          },
          alliesMaxHp: {
            text: 'Allies max HP',
            content:
              'While the Zone from her her Ultimate lasts, Tribbie\'s Max HP increases by an amount equal to 9% of the sum of all ally characters\' Max HP.',
          },
          talentFuaStacks: {
            text: 'FUA stacks',
            content:
              'After using Talent\'s Follow-up ATK, increases the DMG dealt by Tribbie by 72%. This effect can stack up to 3 times, lasting for 3 turns.',
          },
          e1TrueDmg: {
            text: 'E1 True DMG',
            content:
              'While the Zone from her Ultimate lasts and after ally targets attack enemies, additionally deals True DMG equal to 24% of the total DMG of this attack to targets that have been dealt Additional DMG by the Zone.',
          },
          e2AdditionalDmg: {
            text: 'E2 Additional DMG',
            content:
              'The Additional DMG dealt by the Zone increases to 120% of the original DMG. When the Zone deals Additional DMG, further deals 1 instance of Additional DMG.',
          },
          e4DefPen: {
            text: 'E4 DEF PEN',
      ...
      Welt: {
        Content: {
          ...
          e1EnhancedState: {
            ...
            content:
              'After Welt uses his Ultimate, his abilities are enhanced. The next 2 times he uses his Basic ATK or Skill, deals Additional DMG to the target equal to 50% of his Basic ATK\'s DMG multiplier or 80% of his Skill\'s DMG multiplier respectively.',
          },
        },
      },
      Xueyi: {
      ...
      Yukong: {
        Content: {
          ...
          roaringBowstringsActive: {
            ...
            content:
              'When Roaring Bowstrings is active, the ATK of all allies increases by {{skillAtkBuffValue}}%.::BR::E4: When Roaring Bowstrings is active, Yukong deals 30% more DMG to enemies.',
          },
          ultBuff: {
      ...
      Yunli: {
        Content: {
          ...
          ultCull: {
            ...
            content:
              'Intuit: Cull: Deals Physical DMG equal to {{CullScaling}}% of Yunli\'s ATK to the target, and deals Physical DMG equal to {{CullAdjacentScaling}}% of Yunli\'s ATK to adjacent targets. Then, additionally deals 6 instances of DMG, each dealing Physical DMG equal to {{CullAdditionalScaling}}% of Yunli\'s ATK to a random single enemy.',
          },
          ultCullHits: {
  ...
  gameData: {
    ...
    RelicSets: {
      ...
      '113': {
        ...
        Description4pc:
          'When the wearer is hit or has their HP consumed by an ally or themselves, their CRIT Rate increases by 8% for 2 turns and up to 2 stacks.',
      },
      '114': {
      ...
      '115': {
        ...
        Description4pc:
          'When the wearer uses a Follow-up ATK, increases the wearer\'s ATK by 6% for every time the Follow-up ATK deals DMG. This effect can stack up to 8 times and lasts for 3 turns. This effect is removed the next time the wearer uses a Follow-up ATK.',
      },
      '116': {
      ...
      '118': {
        ...
        Description2pc: 'Increases Break Effect by 16%.',
        Description4pc:
          'When the wearer uses their Ultimate on an ally, all allies\' Break Effect increases by 30% for 2 turns. This effect cannot be stacked.',
      },
      '119': {
      ...
      '120': {
        ...
        Description2pc: 'Increases ATK by 12%.',
        Description4pc:
          'Increases the wearer\'s CRIT Rate by 6%. After the wearer uses a Follow-up ATK, increases DMG dealt by Ultimate by 36%, lasting for 1 turn.',
      },
      '121': {
      ...
      '123': {
        ...
        Description2pc: 'Increases ATK by 12%.',
        Description4pc:
          'While the wearer\'s memosprite is on the field, increases the wearer\'s SPD by 6%. When the wearer\'s memosprite attacks, increases the wearer\'s and memosprite\'s CRIT DMG by 30%, lasting for 2 turns.',
      },
      '124': {
      ...
      '126': {
        ...
        Description4pc:
          'When the wearer becomes the target of another ally target\'s ability, gains 1 stack of "Help," stacking up to 2 times. If there are 2 stacks of "Help" when the wearer uses their Ultimate, consumes all "Help" to increase the wearer\'s ATK by 48% for 1 turn.',
      },
      '301': {
      ...
      '313': {
        ...
        Description2pc:
          'Increases the wearer\'s CRIT Rate by 4%. When an enemy target gets defeated, the wearer\'s CRIT DMG increases by 4%, stacking up to 10 times.',
      },
      '314': {
      ...
      '315': {
        ...
        Description2pc:
          'When an ally uses a Follow-up ATK, the wearer gains 1 stack of Merit, stacking up to 5 times. Each stack of Merit increases the DMG dealt by the wearer\'s Follow-up ATKs by 5%. When there are 5 stacks, additionally increases the wearer\'s CRIT DMG by 25%.',
      },
      '316': {
        Name: 'Forge of the Kalpagni Lantern',
        Description2pc:
          'Increases the wearer\'s SPD by 6%. When the wearer hits an enemy target that has Fire Weakness, the wearer\'s Break Effect increases by 40%, lasting for 1 turn.',
      },
      '317': {
      ...
      '321': {
        ...
        Description2pc:
          'When there are more or less than 4 ally targets in battle, each additional/missing ally target increases the wearer and their memosprite\'s DMG by 9%/12%, up to a maximum of 4/3 stacks.',
      },
      '322': {
        Name: 'Revelry by the Sea',
        Description2pc:
          'Increases the wearer\'s DoT DMG by 12%. When the wearer\'s ATK is higher than or equal to 2400/3600, increases the DoT DMG dealt by 12%/24%.',
      },
    },
    Lightcones: {
      '20000': {
  ...
  hint: {
    RatingFilter: {
      ...
      p2:
        'Basic / Skill / Ult / Fua (Follow-up attack) / Dot (Damage over time) / Break (Weakness Break) - Skill damage calculations, based on the environmental factors in character passives / light cone passives / enemy options.',
    ...
    CombatBuffs: {
      Title: 'Combat buffs',
      p1:
        'Additional team buffs to apply to the calculations. Note that buffs from character / light cone self-buffs and passives and traces are already included in calculations.',
    },
    ComboFilters: {
      Title: 'Combo rotation',
      p1:
        'Define the ability rotation to measure Combo DMG. Rotations are defined with [ as the start of a turn, and ] as the end of a turn. See the Advanced Rotation menu and user guide for more details.',
    },
    StatFilters: {
      Title: 'Stat filters',
    ...
    OptimizerOptions: {
      ...
      p1:
        '<0>Character priority filter</0> - When this option is enabled, the character may only steal relics from lower priority characters. The optimizer will ignore relics equipped by higher priority characters on the list. Change character ranks from the priority selector or by dragging them on the Characters page.',
      p2:
        '<0>Boost main stat</0> - Calculates relic mains stats as if they were this level (or their max if they can\'t reach this level) if they are currently below it. Substats are not changed accordingly, so builds with lower level relics may be stronger once you level them.',
      ...
      p4:
        '<0>Include equipped relics</0> - When enabled, the optimizer will allow using relics that are currently equipped by a character for the search. Otherwise equipped relics are excluded',
    ...
    Relics: {
      ...
      p3:
        'Selected character: Average potential - The relic\'s potential at its maximum level, averaged across all the possible rolls it could have on the way to +15',
    ...
    SubstatWeightFilter: {
      ...
      p4:
        'Note that setting the minimum rolls too high may result in some builds not being displayed, if the filter ends up excluding a key relic. Use this filter with caution, but on large searches it makes a large impact on reducing search time.',
    },
    StatDisplay: {
      ...
      p3:
        'Combat stats - The character\'s stats with all stat modifiers in combat included: ability buffs, character & light cone passives, teammates, conditional set effects, etc.',
    },
    ValueColumns: {
      Title: 'Value Columns',
    ...
    LocatorParams: {
      ...
      p2:
        '<0>Auto Filter rows</0> - Maximum number of rows before the relic locator applies a part/set filter to try and bring the searched relic closer to the top of your inventory',
    },
  }
  hometab: {
    CollapseLabels: {
  ...
  importSaveTab: {
    ...
    LoadData: {
      ...
      Stage2: {
        ...
        Label:
          'File contains $t(common:RelicWithCount, {"count": {{relicCount}}}) and $t(common:CharacterWithCount, {"count": {{characterCount}}}). Replace your current data with the uploaded data?',
  ...
  modals: {
    ...
    '0Perms': {
      ...
      RootCauses: {
        ...
        PRIORITY: {
          Description:
            'The character is ranked below other characters on the priority list. When the "Character priority filter" is enabled, characters may only take lower priority characters\' relics',
    ...
    '0Results': {
      ...
      RootCauses: {
        StatView: {
          ...
          Description:
            'Your stat filters are configured for basic stats, which does not include buffs. The Combat stats view will show buffed stats from abilities / teammates / relics / etc.',
    ...
    'ManyPerms': {
      ...
      Text:
        'This optimization search will take a substantial amount of time to finish. You may want to enable the GPU acceleration setting or limit the search to only certain sets and main stats, or use the Substat weight filter to reduce the number of permutations.',
    ...
    'Relic': {
      ...
      SpdInputWarning:
        'Note - SPD substats ingame contain hidden decimal values which are inaccurate if input manually. For precise SPD values, use the Showcase tab or Reliquary Archiver import.',
  ...
  notifications: {
    GPU: {
      ...
      Description: {
        ...
        l4:
          'If you\'re on one of the supported browsers and it doesn\'t work, first try updating your browser version, otherwise try another browser, or try switching your browser to use your dedicated graphics card instead of integrated.',
      },
    },
    GPUCrash: {
  ...
  relicScorerTab: {
    ...
    Header: {
      ...
      WithVersion:
        'Enter your account UID to score your profile characters at level 80 & maxed traces. Log out to refresh instantly. (Current version {{beta_version}})',
    ...
    Disclaimer:
      'Note: Combo DMG is meant to compare different relics relative to the selected team, and should <1>NOT</1> be used to compare different teams / LCs / eidolons!',
  }
  relicsTab: {
    RelicFilterBar: {
      Part: 'Part',
